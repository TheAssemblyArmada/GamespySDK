...
#ifdef GP_NEW_STATUS_INFO
GPResult gpSetStatusInfo(GPConnection* connection,
                         GPEnum statusState,
                         unsigned int hostIp,
                         unsigned int hostPrivateIp,
                         unsigned short queryPort,
...
// gpSendBuddyUTM
/////////////////////
GPResult gpSendBuddyUTM(GPConnection* connection,
                        GPProfile profile,
...
// gpSetCdKey
GPResult gpSetCdKey(GPConnection* connection, const gsi_char cdkeyhash, GPCallback callback);
...
// FILE TRANSFER //
///////////////////
typedef void (*gpSendFilesCallback)(GPConnection* connection,
                                    int index,
                                    const gsi_char** path,
                                    const gsi_char** name,
                                    void* param);

GPResult gpSendFiles(GPConnection* connection,
                     GPTransfer* transfer,
                     GPProfile profile,
                     const gsi_char* message,
