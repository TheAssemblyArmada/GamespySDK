...
//////////////////////////////////////////////////////////////
typedef void (*peerDisconnectedCallback)(PEER peer,              // The peer object.
...
//////////////////////////////////////////////////////////////////
typedef void (*peerRoomMessageCallback)(PEER peer,               // The peer object.
...
//////////////////////////////////////////////////////////////
typedef void (*peerRoomUTMCallback)(PEER peer,                  // The peer object.
...
// PANTS|09.11.00
///////////////////////////////////////////////////////////
typedef void (*peerRoomNameChangedCallback)(PEER peer,         // The peer object.
...
// PANTS|04.17.00
///////////////////////////////////////////////////////////
typedef void (*peerRoomModeChangedCallback)(PEER peer,             // The peer object.
                                            RoomType roomType,     // The type of room that the name changed in.
...
/////////////////////////////////////////////////////////////////
typedef void (*peerPlayerMessageCallback)(PEER peer,               // The peer object.
                                          const gsi_char* nick,    // The nick of the player who sent the message.
                                          const gsi_char* message, // The text of the message.
                                          MessageType messageType, // The type of message.
                                          void* param              // User-data
...
/////////////////////////////////////////////////////////////
typedef void (*peerPlayerUTMCallback)(PEER peer,                  // The peer object.
                                      const gsi_char* nick,       // The nick of the player who sent the UTM.
                                      const gsi_char* command,    // The UTM command for this message.
                                      const gsi_char* parameters, // Any parameters for this UTM.
                                      PEERBool authenticated,     // True if this has been authenticated by the server.
...
//////////////////////////////////////////////
typedef void (*peerReadyChangedCallback)(PEER peer,            // The peer object.
...
////////////////////////////////////////////////////////////
typedef void (*peerGameStartedCallback)(PEER peer,               // The peer object.
...
//////////////////////////
typedef void (*peerPlayerJoinedCallback)(PEER peer,            // The peer object.
...
////////////////////////
typedef void (*peerPlayerLeftCallback)(PEER peer,              // The peer object.
...
///////////////////////////////////////////
typedef void (*peerKickedCallback)(PEER peer,              // The peer object.
...
/////////////////////////////////////////////////////////
typedef void (*peerNewPlayerListCallback)(PEER peer,         // The peer object.
...
/////////////////////////////////////////////////
typedef void (*peerPlayerChangedNickCallback)(PEER peer,               // The peer object.
...
//////////////////////////////////////////////////////////////////
typedef void (*peerPlayerInfoCallback)(PEER peer,            // The peer object.
...
///////////////////////////////////////////////////////
typedef void (*peerPlayerFlagsChangedCallback)(PEER peer,            // The peer object.
...
///////////////////////////////////////////////////////////
typedef void (*peerPingCallback)(PEER peer,            // The peer object.
...
/////////////////////////////////////////////////////////////////
typedef void (*peerCrossPingCallback)(PEER peer,             // The peer object.
...
// set watch keys.
///////////////////////////////////////////////////////////
typedef void (*peerGlobalKeyChangedCallback)(PEER peer,             // The peer object.
...
///////////////////////////////////////////////////////////
typedef void (*peerRoomKeyChangedCallback)(PEER peer,             // The peer object.
...
//////////////////////////////////////////////
typedef void (*peerQRServerKeyCallback)(PEER peer,           // The peer object.
...
// add this key's information to the buffer.
//////////////////////////////////////////////
typedef void (*peerQRPlayerKeyCallback)(PEER peer,           // The peer object.
                                        int key,             // The key for which to report information.
...
// add this key's information to the buffer.
//////////////////////////////////////////////
typedef void (*peerQRTeamKeyCallback)(PEER peer,           // The peer object.
                                      int key,             // The key for which to report information.
...
///////////////////////////////////////////////////////////
typedef int (*peerQRCountCallback)(PEER peer,         // The peer object.
...
//////////////////////////////////////////////////////
typedef void (*peerQRAddErrorCallback)(PEER peer,             // The peer object.
...
///////////////////////////////////////////////////////////////////////
typedef void (*peerQRNatNegotiateCallback)(PEER peer,  // The peer object.
...
///////////////////////////////////////////////////////////////////////////
typedef void (*peerQRPublicAddressCallback)(PEER peer,           // The peer object.
...
/////////////////////////////////////////////////////////
typedef void (*peerConnectCallback)(PEER peer,         // The peer object.
...
/////////////////////////////////////////////////////////
typedef void (*peerNickErrorCallback)(PEER peer,             // The peer object.
...
///////////////////////////////////////////////////////////
void peerConnect(PEER peer,                               // The peer object.
...
/////////////////////////////////////////////////////////////////
void peerConnectLogin(PEER peer,                               // The peer object.
...
/////////////////////////////////////////////////////////////////
void peerConnectPreAuth(PEER peer,                               // The peer object.
...
/////////////////////////////////////////////////////////////////////////
void peerRegisterUniqueNick(PEER peer, int namespaceID, const gsi_char* uniquenick, const gsi_char* cdkey);
...
PEERBool peerSetTitle(
    ...
    PEERBool
        natNegotiate, // PEERTrue if the title supports GameSpy's NAT-negotiation technology (or another similar technology).
...
////////////////////////////////////////////////////////////
void peerFixNick(gsi_char* newNick, const gsi_char* oldNick);

// Removes the namespace extension from a chat unique nick.
// Returns the nick if it ended with the extension.
// Otherwise returns NULL.
///////////////////////////////////////////////////////////
const gsi_char* peerTranslateNick(gsi_char* nick,           // The nick to translate
...
////////////////////////////////////////////////////////////////
typedef void (*peerChangeNickCallback)(PEER peer,               // The peer object.
                                       PEERBool success,        // PEERTrue if success, PEERFalse if failure.
...
///////////////////////////////
void peerChangeNick(PEER peer,                       // The peer object.
...
////////////////////////////////////////////////////
void peerStayInRoom(PEER peer,        // The peer object.
                    RoomType roomType // Only TitleRoom is currently supproted.
);

// Turns quiet mode on/off.
///////////////////////////
void peerSetQuietMode(PEER peer,     // The peer object.
...
////////////////////////////////////////////////
void peerSetAwayMode(PEER peer,             // The peer object.
...
//////////////////////////////////////////////////////////////////////////////
void peerParseQuery(PEER peer,              // The peer object.
...
/////////////////////////////////////////////////////////////////////////
typedef void (*peerAuthenticateCDKeyCallback)(PEER peer,  // The peer object.
...
/////////////////////////////////////////////////////////////
void peerAuthenticateCDKey(PEER peer,                              // The peer object.
...
////////////////////////////////////////////
void peerSendNatNegotiateCookie(PEER peer,           // The peer object.
...
//////////////////////////////////////////////////////////////////
void peerAlwaysGetPlayerInfo(PEER peer,      // The peer object.
...
//////////////////////////////////////////////////////////////////////////
typedef void (*peerJoinRoomCallback)(PEER peer,             // The peer object.
                                     PEERBool success,      // PEERTrue if success, PEERFalse if failure.
...
///////////////////////////////////////////////////
void peerJoinTitleRoom(PEER peer,                                  // The peer object.
...
/////////////////////////////////////////////////////////
void peerJoinGroupRoom(PEER peer,                     // The peer object.
...
/////////////////////////////////////////////////////////////////////////////
void peerSetGroupID(PEER peer,  // The peer object.
...
///////////////////////////////////////////////////////////////////////
int peerGetGroupID(PEER peer // The peer object.
);
...
void peerCreateStagingRoom(PEER peer,                                  // The peer object.
                           ...
                           const gsi_char *password gs_in_reads_z(PEER_PASSWORD_LEN), // An optional password for the staging room
                           peerJoinRoomCallback callback,              // Called when finished.
                           void* param,                                // Passed to the callback.
                           PEERBool blocking                           // If PEERTrue, don't return until finished.
);
...
//////////////////////////////////////////////////////
void peerLeaveRoom(PEER peer,             // The peer object.
...
/////////////////////////////////////////////////////////////////
typedef void (*peerListGroupRoomsCallback)(PEER peer,            // The peer object.
                                           PEERBool success,     // PEERTrue if success, PEERFalse if failure.
...
//   on each group room.
/////////////////////////////////////////////////////////
void peerListGroupRooms(PEER peer,                           // The peer object.
...
//   to included.
/////////////////////////////////////////////////////////////////////
void peerStartListingGames(PEER peer,                   // The peer object.
...
////////////////////////////////////////////////////////////////////
void peerStopListingGames(PEER peer // The peer object.
);
...
///////////////////////////////////////////////////////////////////
void peerUpdateGame(PEER peer,          // The peer object.
...
// peerStartListingGames as the fields parameter will be requested.
///////////////////////////////////////////////////////////////////
void peerUpdateGameByMaster(PEER peer,          // The peer object.
                            SBServer server,    // The server object for the game to update.
                            PEERBool fullUpdate // If true, get all of the game's keys.
);
...
////////////////////////////
void peerMessageRoom(PEER peer,               // The peer object.
...
////////////////////////
void peerUTMRoom(PEER peer,                  // The peer object.
...
///////////////////////////////////////////////////////////
void peerSetPassword(PEER peer,                                 // The peer object.
...
// PANTS|09.11.00
////////////////////////////////////////////////////////
void peerSetRoomName(PEER peer,           // The peer object.
...
///////////////////////////////////////////
const gsi_char* peerGetRoomName(PEER peer,        // The peer object.
...
// Returns NULL if not in the room.
///////////////////////////////////////////////////
const gsi_char* peerGetRoomChannel(PEER peer,        // The peer object.
                                   RoomType roomType // The room to get the channel for.
);

// Returns PEERTrue if in the room.
///////////////////////////////////
PEERBool peerInRoom(PEER peer,        // The peer object.
...
// This function is normally not needed.
///////////////////////////////////////////////////////////////////
void peerSetTitleRoomChannel(PEER peer,              // The peer object.
...
//////////////////////////////////////////////////////////////
typedef void (*peerEnumPlayersCallback)(PEER peer,         // The peer object.
                                        PEERBool success,  // PEERTrue if success, PEERFalse if failure.
...
////////////////////////////////////////////
void peerEnumPlayers(PEER peer,                        // The peer object.
...
//////////////////////////////
void peerMessagePlayer(PEER peer,               // The peer object.
...
//////////////////////////
void peerUTMPlayer(PEER peer,                  // The peer object.
...
///////////////////////////////////////////////////////
void peerKickPlayer(PEER peer,             // The peer object.
...
/////////////////////////////////////////////////////////////////////////////
PEERBool peerGetPlayerPing(PEER peer,            // The peer object.
...
///////////////////////////////////////////////////////////////////////////
PEERBool peerGetPlayersCrossPing(PEER peer,             // The peer object.
...
////////////////////////////////////////////////////////////////////////////
PEERBool peerPingPlayer(PEER peer,           // The peer object.
...
///////////////////////////////////////////////////////
typedef void (*peerGetPlayerInfoCallback)(PEER peer,            // The peer object.
                                          PEERBool success,     // PEERTrue if success, PEERFalse if failure.
...
//////////////////////////////////////////////
void peerGetPlayerInfo(PEER peer,                          // The peer object.
                       const gsi_char* nick,               // The player's nick.
...
////////////////////////////////////////////////////////////
typedef void (*peerGetPlayerProfileIDCallback)(PEER peer,            // The peer object.
                                               PEERBool success,     // PEERTrue if success, PEERFalse if failure.
                                               const gsi_char* nick, // The player's nick.
                                               int profileID,        // The player's profile ID.
                                               void* param           // User-data.
...
///////////////////////////////////////
void peerGetPlayerProfileID(PEER peer,                               // The peer object.
                            const gsi_char* nick,                    // The player's nick.
...
// DEPRECATED - Use peerGetPlayerInfo.
//////////////////////////////////////
void peerGetPlayerIP(PEER peer,                        // The peer object.
                     const gsi_char* nick,             // The player's nick.
...
////////////////////////////////////////////
PEERBool peerIsPlayerHost(PEER peer,            // The peer object.
                          const gsi_char* nick, // The player's nick.
...
/////////////////////////////////////////////
void peerSetReady(PEER peer,     // The peer object.
                  PEERBool ready // Ready or not.
);

// Gets a player's ready state.
///////////////////////////////
PEERBool peerGetReady(PEER peer,            // The peer object.
                      const gsi_char* nick, // The player's nick.
...
////////////////////////////////////////////////////////////
PEERBool peerAreAllReady(PEER peer // The peer object.
);
...
/////////////////////////////////////////////////////////////////////////////
void peerStartGame(PEER peer,               // The peer object.
...
////////////////////////////////////////////////////////////////
PEERBool peerStartReporting(PEER peer // The peer object.
);
...
// games behind a NAT proxy possible.
////////////////////////////////////////////////////////////////
PEERBool peerStartReportingWithSocket(PEER peer,          // The peer object.
                                      SOCKET socket,      // The socket to be used for reporting.
                                      unsigned short port // The local port to which the socket is bound.
);
...
///////////////////////////////////////////////////////
void peerStartPlaying(PEER peer // The peer object.
);

// Check to see if the local player is playing.
///////////////////////////////////////////////
PEERBool peerIsPlaying(PEER peer // The peer object.
);

// Needs to be called by the host when the game has stopped.
////////////////////////////////////////////////////////////
void peerStopGame(PEER peer // The peer object.
);
...
// PANTS|09.11.00
///////////////////////////////////////////////////////////////////
void peerStateChanged(PEER peer // The peer object.
);
...
///////////////////////////////////////
void peerSetGlobalKeys(PEER peer,              // The peer object.
...
//////////////////////////////////////
typedef void (*peerGetGlobalKeysCallback)(PEER peer,               // The peer object.
...
//////////////////////////////
void peerGetPlayerGlobalKeys(PEER peer,                          // The peer object.
...
//////////////////////////////////////////////////////////
void peerGetRoomGlobalKeys(PEER peer,                          // The peer object.
...
/////////////////////////////////////////////////
void peerSetRoomKeys(PEER peer,              // The peer object.
...
////////////////////////////////////
typedef void (*peerGetRoomKeysCallback)(PEER peer,            // The peer object.
                                        PEERBool success,     // If PEERFalse, unable to get the keys.
...
//////////////////////////////////////////////////////////////////
void peerGetRoomKeys(PEER peer,                        // The peer object.
                     RoomType roomType,                // The room to get the keys in.
                     const gsi_char* nick,             // The player to get the keys for.
                     int num,                          // The number of keys.
                     const gsi_char** keys,            // The keys to get.
...
// cache these keys for all players in the room.
////////////////////////////////////////////////////////////
void peerSetRoomWatchKeys(PEER peer,             // The peer object.
                          RoomType roomType,     // The type of room to set the watch keys for.
                          int num,               // The number of keys.
                          const gsi_char** keys, // The keys to watch for.
...
///////////////////////////////////////////////////////////////
const gsi_char* peerGetGlobalWatchKey(PEER peer,            // The peer object.
...
// If the key is empty, "" will be returned.
///////////////////////////////////////////////////////////////
const gsi_char* peerGetRoomWatchKey(PEER peer,            // The peer object.
...
/////////////////////////////////////////////////////////////////////
typedef void (*peerAutoMatchStatusCallback)(PEER peer,                  // The peer object.
...
///////////////////////////////////////////////////////////////////////////////
typedef int (*peerAutoMatchRateCallback)(PEER peer,      // The peer object.
...
/////////////////////////////////////////////////////////////////////////////////
void peerStartAutoMatch(PEER peer,              // The peer object.
...
// games behind a NAT proxy possible.
////////////////////////////////////////////////////////////////
void peerStartAutoMatchWithSocket(PEER peer,      // The peer object.
                                  int maxPlayers, // The total number of players to match (including the local player).
                                  const gsi_char* filter, // Hard criteria - filters out servers.
                                  SOCKET socket,          // The socket to be used for reporting.
                                  unsigned short port,    // The local port to which the socket is bound.
