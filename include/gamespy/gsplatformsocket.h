...
GS_SOCKET_ERROR
gsiSocketSendto(GSI_SOCKET sock, const char* buf, int len, int flags, const GS_SOCKADDR* addr, int tolen);
...
gsiSocketGethostbyaddr(a, l, t) SOC_GetHostByAddr(a, l, t) gsiSocketGethostbyname(n) SOC_GetHostByName(n)
