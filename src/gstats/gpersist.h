...
*****************/
typedef void (*PersDataCallbackFn)(int localid,
                                   int profileid,
                                   persisttype_t type,
                                   int index,
                                   int success,
...
*****************/
typedef void (*PersDataSaveCallbackFn)(int localid,
                                       int profileid,
                                       persisttype_t type,
                                       int index,
                                       int success,
...
void PreAuthenticatePlayerPM(int localid,
                             ...
                             PersAuthCallbackFn callback,
                             void* instance);
void PreAuthenticatePlayerCD(int localid,
                             const gsi_char* nick,
                             const char* keyhash,
                             const char* challengeresponse,
                             PersAuthCallbackFn callback,
...
instance: Pointer that will be passed to the callback function (for your use)
*****************/
void GetProfileIDFromCD(int localid,
                        const gsi_char* nick,
                        const char* keyhash,
...
void GetPersistDataValues(int localid,
                          ...
                          PersDataCallbackFn callback,
                          void* instance);
void GetPersistDataValuesModified(int localid,
                                  int profileid,
                                  persisttype_t type,
                                  int index,
                                  time_t modifiedsince,
