...
//FUNCTIONS
///////////
static GPResult gpiSendRegisterUniqueNick(GPConnection* connection,
...
GPResult gpiRegisterUniqueNick(GPConnection* connection,
                               const char uniquenick[GP_UNIQUENICK_LEN],
                               const char cdkey[GP_CDKEY_LEN],
                               GPEnum blocking,
                               GPCallback callback,
...
static GPResult gpiSendRegisterCdKey(GPConnection* connection, const char cdkey[GP_CDKEY_LEN], int operationid)
{
    GPIConnection* iconnection = (GPIConnection*)*connection;
...
GPResult gpiRegisterCdKey(GPConnection* connection,
                          const char cdkey[GP_CDKEY_LEN],
                          GPEnum blocking,
                          GPCallback callback,
                          void* param)
