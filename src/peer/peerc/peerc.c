...
// RoomType to string
gsi_char RtoS[3][16] = {_T("TitleRoom"), _T("GroupRoom"), _T("StagingRoom")};
...
static void
CreateStagingRoomCallback(PEER peer, PEERBool success, PEERJoinResult result, RoomType roomType, void* param)
{
    if (success)
...
static void DisconnectedCallback(PEER peer, const gsi_char* reason, void* param)
{
...
static void RoomMessageCallback(PEER peer,
                                RoomType roomType,
                                const gsi_char* nick,
...
static void RoomUTMCallback(PEER peer,
                            RoomType roomType,
                            const gsi_char* nick,
...
static void
PlayerMessageCallback(PEER peer, const gsi_char* nick, const gsi_char* message, MessageType messageType, void* param)
{
...
static void ReadyChangedCallback(PEER peer, const gsi_char* nick, PEERBool ready, void* param)
{
    if (ready)
...
static void GameStartedCallback(PEER peer, SBServer server, const gsi_char* message, void* param)
{
...
static void PlayerJoinedCallback(PEER peer, RoomType roomType, const gsi_char* nick, void* param)
{
...
static void PlayerLeftCallback(PEER peer, RoomType roomType, const gsi_char* nick, const gsi_char* reason, void* param)
{
...
static void
PlayerChangedNickCallback(PEER peer, RoomType roomType, const gsi_char* oldNick, const gsi_char* newNick, void* param)
{
...
static void EnumPlayersCallback(PEER peer,
                                PEERBool success,
                                RoomType roomType,
                                int index,
                                const gsi_char* nick,
...
*/
static void ListGroupRoomsCallback(PEER peer,
                                   PEERBool success,
                                   int groupID,
                                   SBServer server,
                                   const gsi_char* name,
...
static void NickErrorCallback(PEER peer,
                              int type,
...
*/
static void RoomKeyChangedCallback(PEER thePeer,
                                   RoomType theType,
                                   const gsi_char* theNick,
                                   const gsi_char* theKey,
