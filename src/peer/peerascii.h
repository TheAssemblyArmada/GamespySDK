...
///////////////////////////////////////////////////////////
void peerConnectA(PEER peer,                               // The peer object.
...
/////////////////////////////////////////////////////////////////
void peerConnectLoginA(PEER peer,                               // The peer object.
...
/////////////////////////////////////////////////////////////////
void peerConnectPreAuthA(PEER peer,                               // The peer object.
...
///////////////////////////////////////////////////////////
const char* peerTranslateNickA(char* nick,           // The nick to translate
                               const char* extension // The extension to be removed.
);

// Changes the user's nickname.
///////////////////////////////
void peerChangeNickA(PEER peer,                       // The peer object.
...
////////////////////////////////////////////////
void peerSetAwayModeA(PEER peer,         // The peer object.
...
//////////////////////////////////////////////////////////////////////////////
void peerParseQueryA(PEER peer,              // The peer object.
...
/////////////////////////////////////////////////////////////
void peerAuthenticateCDKeyA(PEER peer,                              // The peer object.
...
///////////////////////////////////////////////////
void peerJoinTitleRoomA(PEER peer,                              // The peer object.
...
/////////////////////////////////////////////////////////////
void peerCreateStagingRoomA(PEER peer,                              // The peer object.
...
//////////////////////////////////////////////////////
void peerLeaveRoomA(PEER peer,         // The peer object.
...
//   on each group room.
/////////////////////////////////////////////////////////
void peerListGroupRoomsA(PEER peer,                           // The peer object.
...
//   to included.
/////////////////////////////////////////////////////////////////////
void peerStartListingGamesA(PEER peer,                   // The peer object.
...
////////////////////////////
void peerMessageRoomA(PEER peer,              // The peer object.
...
////////////////////////
void peerUTMRoomA(PEER peer,              // The peer object.
...
///////////////////////////////////////////////////////////
void peerSetPasswordA(PEER peer,                             // The peer object.
...
// PANTS|09.11.00
////////////////////////////////////////////////////////
void peerSetRoomNameA(PEER peer,         // The peer object.
...
///////////////////////////////////////////
const char* peerGetRoomNameA(PEER peer,        // The peer object.
...
// Returns NULL if not in the room.
///////////////////////////////////////////////////
const char* peerGetRoomChannelA(PEER peer,        // The peer object.
...
///////////////////////////////////////////////////////////////////
void peerSetTitleRoomChannelA(PEER peer,          // The peer object.
...
//////////////////////////////
void peerMessagePlayerA(PEER peer,              // The peer object.
...
//////////////////////////
void peerUTMPlayerA(PEER peer,              // The peer object.
...
///////////////////////////////////////////////////////
void peerKickPlayerA(PEER peer,         // The peer object.
...
/////////////////////////////////////////////////////////////////////////////
PEERBool peerGetPlayerPingA(PEER peer,        // The peer object.
...
///////////////////////////////////////////////////////////////////////////
PEERBool peerGetPlayersCrossPingA(PEER peer,         // The peer object.
...
////////////////////////////////////////////////////////////////////////////
PEERBool peerPingPlayerA(PEER peer,       // The peer object.
...
//////////////////////////////////////////////
void peerGetPlayerInfoA(PEER peer,                          // The peer object.
...
///////////////////////////////////////
void peerGetPlayerProfileIDA(PEER peer,                               // The peer object.
                             const char* nick,                        // The player's nick.
...
// DEPRECATED - Use peerGetPlayerInfo.
//////////////////////////////////////
void peerGetPlayerIPA(PEER peer,                        // The peer object.
                      const char* nick,                 // The player's nick.
...
////////////////////////////////////////////
PEERBool peerIsPlayerHostA(PEER peer,        // The peer object.
                           const char* nick, // The player's nick.
...
///////////////////////////////
PEERBool peerGetReadyA(PEER peer,        // The peer object.
                       const char* nick, // The player's nick.
...
/////////////////////////////////////////////////////////////////////////////
void peerStartGameA(PEER peer,           // The peer object.
...
///////////////////////////////////////
void peerSetGlobalKeysA(PEER peer,          // The peer object.
...
//////////////////////////////
void peerGetPlayerGlobalKeysA(PEER peer,                          // The peer object.
...
//////////////////////////////////////////////////////////
void peerGetRoomGlobalKeysA(PEER peer,                          // The peer object.
...
/////////////////////////////////////////////////
void peerSetRoomKeysA(PEER peer,          // The peer object.
...
//////////////////////////////////////////////////////////////////
void peerGetRoomKeysA(PEER peer,                        // The peer object.
                      RoomType roomType,                // The room to get the keys in.
                      const char* nick,                 // The player to get the keys for.
                      int num,                          // The number of keys.
                      const char** keys,                // The keys to get.
...
///////////////////////////////////////////////////////////////
const char* peerGetGlobalWatchKeyA(PEER peer,        // The peer object.
...
// If the key is empty, "" will be returned.
///////////////////////////////////////////////////////////////
const char* peerGetRoomWatchKeyA(PEER peer,         // The peer object.
...
/////////////////////////////////////////////////////////////////////////////////
void peerStartAutoMatchA(PEER peer,          // The peer object.
...
// games behind a NAT proxy possible.
////////////////////////////////////////////////////////////////
void peerStartAutoMatchWithSocketA(PEER peer,      // The peer object.
                                   int maxPlayers, // The total number of players to match (including the local player).
                                   const char* filter,  // Hard criteria - filters out servers.
                                   SOCKET socket,       // The socket to be used for reporting.
                                   unsigned short port, // The local port to which the socket is bound.
