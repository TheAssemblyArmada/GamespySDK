...
/* Chat.
*******/
static PEERBool piIsOldUTM(const char* message)
{
...
/////////////////////////////
static PEERBool piParseUTM(const char* message)
{
    int len;
...
static void piProcessUTM(PEER peer, piPlayer* player, PEERBool inRoom, RoomType roomType)
{
...
static void piHandleOldNFO(PEER peer, piPlayer* player, const char* message)
{
...
static void
piChannelMessageA(CHAT chat, const char* channel, const char* user, const char* message, int type, PEER peer)
{
    piPlayer* player;
    RoomType roomType;
    ...
    if ((type == CHAT_UTM) || (type == CHAT_ATM)) {
        if (piParseUTM(message)) {
            ...
            // Pass it along.
            /////////////////
            piAddRoomUTMCallback(
                peer, roomType, user, piUTMCommand, piUTMParameters, (type == CHAT_ATM) ? PEERTrue : PEERFalse);
        }
...
#ifdef GSI_UNICODE
static void piChannelMessageW(CHAT chat,
...
static void piChannelKickedA(CHAT chat, const char* channel, const char* user, const char* reason, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piChannelKickedW(CHAT chat,
                             const unsigned short* channel,
                             const unsigned short* user,
...
static void piChannelUserJoinedA(CHAT chat, const char* channel, const char* user, int mode, PEER peer)
{
    RoomType roomType;
    piPlayer* player;
    ...
    if ((roomType == StagingRoom) && peerIsAutoMatching(peer)) {
        ...
        ////////////////////////////////////////////
        if ((connection->autoMatchStatus == PEERStaging)
            && (connection->numPlayers[StagingRoom] >= connection->maxPlayers))
...
#ifdef GSI_UNICODE
static void
piChannelUserJoinedW(CHAT chat, const unsigned short* channel, const unsigned short* user, int mode, PEER peer)
{
    char* channel_A = UCS2ToUTF8StringAlloc(channel);
    char* user_A = UCS2ToUTF8StringAlloc(user);
...
static void piChannelUserPartedA(CHAT chat,
                                 const char* channel,
                                 const char* user,
                                 int why,
                                 const char* reason,
...
#ifdef GSI_UNICODE
static void piChannelUserPartedW(CHAT chat,
                                 const unsigned short* channel,
                                 const unsigned short* user,
                                 int why,
                                 const unsigned short* reason,
...
static void
piChannelUserChangedNickA(CHAT chat, const char* channel, const char* oldNick, const char* newNick, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piChannelUserChangedNickW(CHAT chat,
                                      const unsigned short* channel,
...
static void piChannelTopicChangedA(CHAT chat, const char* channel, const char* topic, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piChannelTopicChangedW(CHAT chat, const unsigned short* channel, const unsigned short* topic, PEER peer)
{
    char* channel_A = UCS2ToUTF8StringAlloc(channel);
...
static void piChannelNewUserListA(CHAT chat, const char* channel, int num, const char** users, int* modes, PEER peer)
{
    int i;
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piChannelNewUserListW(CHAT chat,
                                  const unsigned short* channel,
                                  int num,
...
static void
piBroadcastKeyChangedA(CHAT chat, const char* channel, const char* user, const char* key, const char* value, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piBroadcastKeyChangedW(CHAT chat,
                                   const unsigned short* channel,
                                   const unsigned short* user,
...
static void piUserModeChangedA(CHAT chat, const char* channel, const char* user, int mode, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void
piUserModeChangedW(CHAT chat, const unsigned short* channel, const unsigned short* user, int mode, PEER peer)
{
    char* channel_A = UCS2ToUTF8StringAlloc(channel);
    char* user_A = UCS2ToUTF8StringAlloc(user);
...
static void piChannelModeChangedA(CHAT chat, const char* channel, CHATChannelMode* mode, PEER peer)
{
    RoomType roomType;
...
#ifdef GSI_UNICODE
static void piChannelModeChangedW(CHAT chat, const unsigned short* channel, CHATChannelMode* mode, PEER peer)
{
    char* channel_A = UCS2ToUTF8StringAlloc(channel);
