...
{
    piCallbackType type;
    PEERBool (*copy)(void* paramsOut, void* paramsIn);
    void (*gsifree)(void* params);
    void (*call)(PEER peer, piCallbackData* data);
} piCallbackFuncs;
...
void piAddConnectCallback(PEER peer,
                          PEERBool success,
                          int failureReason,
                          ...
                          int opID)
{
    ...
    piAddCallback(
        peer, success, (PEERCBType)callback, param, PI_CONNECT_CALLBACK, &params, sizeof(piConnectParams), opID);
}
...
static void piJoinRoomCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
    ((peerJoinRoomCallback)(PEERCBType)data->callback)(
        peer, data->success, params->result, params->roomType, data->callbackParam);
}
void piAddJoinRoomCallback(PEER peer,
                           PEERBool success,
                           PEERJoinResult result,
                           RoomType roomType,
                           ...
                           int opID)
{
    ...
    piAddCallback(
        peer, success, (PEERCBType)callback, param, PI_JOIN_ROOM_CALLBACK, &params, sizeof(piJoinRoomParams), opID);
}
...
static void piListGroupRoomsCall(PEER peer, piCallbackData* data)
{
...
#ifndef GSI_UNICODE
    ((peerListGroupRoomsCallback)(PEERCBType)data->callback)(peer,
                                                             data->success,
                                                             params->groupID,
                                                             params->server,
                                                             params->name,
...
#else
    {
        ...
        ((peerListGroupRoomsCallback)(int)data->callback)(peer,
                                                          data->success,
                                                          params->groupID,
                                                          params->server,
                                                          name_W,
...
void piAddListGroupRoomsCallback(PEER peer,
                                 PEERBool success,
                                 int groupID,
                                 SBServer server,
                                 const char* name,
...
static void piListingGamesCall(PEER peer, piCallbackData* data)
{
...
#ifndef GSI_UNICODE
    ((peerListingGamesCallback)(PEERCBType)data->callback)(peer,
                                                           data->success,
                                                           params->name,
                                                           params->server,
                                                           params->staging,
...
#else
    {
        ...
        if (params->name != NULL)
            name_W = UTF8ToUCS2StringAlloc(params->name);
        ((peerListingGamesCallback)(int)data->callback)(peer,
                                                        data->success,
                                                        name_W,
                                                        params->server,
                                                        params->staging,
...
void piAddListingGamesCallback(PEER peer, PEERBool success, SBServer server, int msg)
{
    ...
    piAddCallback(peer,
                  success,
                  (PEERCBType)connection->gameListCallback,
                  connection->gameListParam,
                  PI_LISTING_GAMES_CALLBACK,
                  &params,
                  sizeof(piListingGamesParams),
                  -1);
}
...
static void piNickErrorCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerNickErrorCallback)(PEERCBType)data->callback)(peer,
                                                        params->type,
                                                        params->nick,
                                                        params->numSuggestedNicks,
                                                        (const char**)params->suggestedNicks,
                                                        data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        unsigned short** suggestedNicks_W =
            UTF8ToUCS2StringArrayAlloc((const UTF8String*)params->suggestedNicks, params->numSuggestedNicks);
        int i;
        ((peerNickErrorCallback)data->callback)(peer,
                                                params->type,
                                                nick_W,
                                                params->numSuggestedNicks,
                                                (const unsigned short**)suggestedNicks_W,
                                                data->callbackParam);
        gsifree(nick_W);
        for (i = 0; i < params->numSuggestedNicks; i++) {
...
void piAddNickErrorCallback(PEER peer,
                            int type,
                            const char* nick,
                            int numSuggestedNicks,
                            ...
                            int opID)
{
    ...
    piAddCallback(peer,
                  PEERFalse,
                  (PEERCBType)connection->nickErrorCallback,
                  param,
                  PI_NICK_ERROR_CALLBACK,
                  &params,
                  sizeof(piNickErrorParams),
                  opID);
}
...
static void piEnumPlayersCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerEnumPlayersCallback)data->callback)(
        peer, data->success, params->roomType, params->index, params->nick, params->flags, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ((peerEnumPlayersCallback)data->callback)(
            peer, data->success, params->roomType, params->index, nick_W, params->flags, data->callbackParam);
        gsifree(nick_W);
    }
#endif
}
void piAddEnumPlayersCallback(PEER peer,
                              PEERBool success,
                              RoomType roomType,
                              int index,
                              const char* nick,
...
static void piGetPlayerInfoCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerGetPlayerInfoCallback)data->callback)(
        peer, data->success, params->nick, params->IP, params->profileID, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ((peerGetPlayerInfoCallback)data->callback)(
            peer, data->success, nick_W, params->IP, params->profileID, data->callbackParam);
        gsifree(nick_W);
    }
#endif
}
void piAddGetPlayerInfoCallback(PEER peer,
                                PEERBool success,
                                const char* nick,
                                unsigned int IP,
                                int profileID,
...
static void piGetPlayerProfileIDCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerGetPlayerProfileIDCallback)data->callback)(
        peer, data->success, params->nick, params->profileID, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ((peerGetPlayerProfileIDCallback)data->callback)(
            peer, data->success, nick_W, params->profileID, data->callbackParam);
        gsifree(nick_W);
    }
#endif
}
void piAddGetPlayerProfileIDCallback(PEER peer,
                                     PEERBool success,
                                     const char* nick,
                                     int profileID,
                                     ...
                                     int opID)
{
    ...
    piAddCallback(peer,
                  ...
                  &params,
                  sizeof(piGetPlayerProfileIDParams),
                  opID);
}
...
void piAddGetPlayerIPCallback(PEER peer,
                              PEERBool success,
                              const char* nick,
                              unsigned int IP,
...
static void piRoomMessageCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerRoomMessageCallback)data->callback)(
        peer, params->roomType, params->nick, params->message, params->messageType, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ...
        ((peerRoomMessageCallback)data->callback)(
            peer, params->roomType, nick_W, message_W, params->messageType, data->callbackParam);
        gsifree(nick_W);
        gsifree(message_W);
    }
#endif
}
void piAddRoomMessageCallback(PEER peer,
                              RoomType roomType,
                              const char* nick,
                              const char* message,
                              MessageType messageType)
{
    ...
    if (callbacks->roomMessage) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->roomMessage,
                      callbacks->param,
                      PI_ROOM_MESSAGE_CALLBACK,
                      &params,
                      sizeof(piRoomMessageParams),
                      -1);
    }
}
...
static void piRoomUTMCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerRoomUTMCallback)data->callback)(peer,
                                          params->roomType,
                                          params->nick,
                                          params->command,
                                          params->parameters,
...
#else
    {
        ...
        ((peerRoomUTMCallback)data->callback)(
            peer, params->roomType, nick_W, command_W, parameters_W, params->authenticated, data->callbackParam);
        gsifree(nick_W);
        gsifree(command_W);
...
void piAddRoomUTMCallback(PEER peer,
                          RoomType roomType,
                          const char* nick,
                          const char* command,
                          ...
                          PEERBool authenticated)
{
    ...
    if (callbacks->roomUTM) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->roomUTM,
                      callbacks->param,
                      PI_ROOM_UTM_CALLBACK,
                      &params,
                      sizeof(piRoomUTMParams),
                      -1);
    }
}
...
void piAddRoomNameChangedCallback(PEER peer, RoomType roomType)
{
    ...
    if (callbacks->roomNameChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->roomNameChanged,
                      callbacks->param,
                      PI_ROOM_NAME_CHANGED_CALLBACK,
                      &params,
                      sizeof(piRoomNameChangedParams),
                      -1);
    }
}
...
void piAddRoomModeChangedCallback(PEER peer, RoomType roomType, CHATChannelMode* mode)
{
    ...
    if (callbacks->roomModeChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->roomModeChanged,
                      callbacks->param,
                      PI_ROOM_MODE_CHANGED_CALLBACK,
                      &params,
                      sizeof(piRoomModeChangedParams),
                      -1);
    }
}
...
static void piPlayerMessageCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerPlayerMessageCallback)data->callback)(
        peer, params->nick, params->message, params->messageType, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        unsigned short* message_W = UTF8ToUCS2StringAlloc(params->message);
...
void piAddPlayerMessageCallback(PEER peer, const char* nick, const char* message, MessageType messageType)
{
    ...
    if (callbacks->playerMessage) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerMessage,
                      callbacks->param,
                      PI_PLAYER_MESSAGE_CALLBACK,
                      &params,
                      sizeof(piPlayerMessageParams),
                      -1);
    }
}
...
static void piPlayerUTMCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerPlayerUTMCallback)data->callback)(
        peer, params->nick, params->command, params->parameters, params->authenticated, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        unsigned short* command_W = UTF8ToUCS2StringAlloc(params->command);
        unsigned short* parameters_W = UTF8ToUCS2StringAlloc(params->parameters);
        ((peerPlayerUTMCallback)data->callback)(
            peer, nick_W, command_W, parameters_W, params->authenticated, data->callbackParam);
        gsifree(nick_W);
        gsifree(command_W);
        gsifree(parameters_W);
    }
...
void piAddPlayerUTMCallback(PEER peer,
                            const char* nick,
                            const char* command,
                            const char* parameters,
                            PEERBool authenticated)
{
    ...
    if (callbacks->playerUTM) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerUTM,
                      callbacks->param,
                      PI_PLAYER_UTM_CALLBACK,
                      &params,
                      sizeof(piPlayerUTMParams),
                      -1);
    }
}
...
void piAddReadyChangedCallback(PEER peer, const char* nick, PEERBool ready)
{
    ...
    if (callbacks->readyChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->readyChanged,
                      callbacks->param,
                      PI_READY_CHANGED_CALLBACK,
                      &params,
                      sizeof(piReadyChangedParams),
                      -1);
    }
}
...
void piAddGameStartedCallback(PEER peer, SBServer server, const char* message)
{
    ...
    if (callbacks->gameStarted) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->gameStarted,
                      callbacks->param,
                      PI_GAME_STARTED_CALLBACK,
                      &params,
                      sizeof(piGameStartedParams),
                      -1);
    }
}
...
void piAddPlayerJoinedCallback(PEER peer, RoomType roomType, const char* nick)
{
    ...
    if (callbacks->playerJoined) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerJoined,
                      callbacks->param,
                      PI_PLAYER_JOINED_CALLBACK,
                      &params,
                      sizeof(piPlayerJoinedParams),
                      -1);
    }
}
...
void piAddPlayerLeftCallback(PEER peer, RoomType roomType, const char* nick, const char* reason)
{
    ...
    if (callbacks->playerLeft) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerLeft,
                      callbacks->param,
                      PI_PLAYER_LEFT_CALLBACK,
                      &params,
                      sizeof(piPlayerLeftParams),
                      -1);
    }
}
...
void piAddKickedCallback(PEER peer, RoomType roomType, const char* nick, const char* reason)
{
    ...
    if (callbacks->kicked) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->kicked,
                      callbacks->param,
                      PI_KICKED_CALLBACK,
                      &params,
                      sizeof(piKickedParams),
                      -1);
    }
}
...
void piAddNewPlayerListCallback(PEER peer, RoomType roomType)
{
    ...
    if (callbacks->newPlayerList) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->newPlayerList,
                      callbacks->param,
                      PI_NEW_PLAYER_LIST_CALLBACK,
                      &params,
                      sizeof(piNewPlayerListParams),
                      -1);
    }
}
...
static void piPlayerChangedNickCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerPlayerChangedNickCallback)data->callback)(
        peer, params->roomType, params->oldNick, params->newNick, data->callbackParam);
#else
    {
        ...
        ((peerPlayerChangedNickCallback)data->callback)(
            peer, params->roomType, oldNick_W, newNick_W, data->callbackParam);
        gsifree(oldNick_W);
        gsifree(newNick_W);
    }
#endif
...
void piAddPlayerChangedNickCallback(PEER peer, RoomType roomType, const char* oldNick, const char* newNick)
{
    ...
    if (callbacks->playerChangedNick) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerChangedNick,
                      callbacks->param,
                      PI_PLAYER_CHANGED_NICK_CALLBACK,
                      &params,
                      sizeof(piPlayerChangedNickParams),
                      -1);
    }
}
...
#ifndef GSI_UNICODE
    ((peerPlayerInfoCallback)data->callback)(
        peer, params->roomType, params->nick, params->IP, params->profileID, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ((peerPlayerInfoCallback)data->callback)(
            peer, params->roomType, nick_W, params->IP, params->profileID, data->callbackParam);
        gsifree(nick_W);
    }
#endif
}
void piAddPlayerInfoCallback(PEER peer, RoomType roomType, const char* nick, unsigned int IP, int profileID)
{
    ...
    if (callbacks->playerInfo) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerInfo,
                      callbacks->param,
                      PI_PLAYER_INFO_CALLBACK,
                      &params,
                      sizeof(piPlayerInfoParams),
                      -1);
    }
}
...
void piAddDisconnectedCallback(PEER peer, const char* reason)
{
    ...
    if (callbacks->disconnected) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->disconnected,
                      callbacks->param,
                      PI_DISCONNECTED_CALLBACK,
                      &params,
                      sizeof(piDisconnectedParams),
                      -1);
    }
}
...
void piAddCrossPingCallback(PEER peer, const char* nick1, const char* nick2, int crossPing)
{
    ...
    if (callbacks->crossPing) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->crossPing,
                      callbacks->param,
                      PI_CROSS_PING_CALLBACK,
                      &params,
                      sizeof(piCrossPingParams),
                      -1);
    }
}
...
static void piChangeNickCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerChangeNickCallback)data->callback)(
        peer, data->success, params->oldNick, params->newNick, data->callbackParam);
#else
    {
        unsigned short* oldNick_W = UTF8ToUCS2StringAlloc(params->oldNick);
        unsigned short* newNick_W = UTF8ToUCS2StringAlloc(params->newNick);
...
void piAddChangeNickCallback(PEER peer,
                             PEERBool success,
                             const char* oldNick,
                             const char* newNick,
                             ...
                             int opID)
{
    ...
    piAddCallback(
        peer, success, (PEERCBType)callback, param, PI_CHANGE_NICK_CALLBACK, &params, sizeof(piChangeNickParams), opID);
}
...
void piAddGlobalKeyChangedCallback(PEER peer, const char* nick, const char* key, const char* value)
{
    ...
    if (callbacks->globalKeyChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->globalKeyChanged,
                      callbacks->param,
                      PI_GLOBAL_KEY_CHANGED_CALLBACK,
                      &params,
                      sizeof(piGlobalKeyChangedParams),
                      -1);
    }
}
...
static void piRoomKeyChangedCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerRoomKeyChangedCallback)data->callback)(
        peer, params->roomType, params->nick, params->key, params->value, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        unsigned short* key_W = UTF8ToUCS2StringAlloc(params->key);
        unsigned short* value_W = UTF8ToUCS2StringAlloc(params->value);
        ((peerRoomKeyChangedCallback)data->callback)(
            peer, params->roomType, nick_W, key_W, value_W, data->callbackParam);
        gsifree(nick_W);
        gsifree(key_W);
        gsifree(value_W);
    }
...
void piAddRoomKeyChangedCallback(PEER peer, RoomType roomType, const char* nick, const char* key, const char* value)
{
    ...
    if (callbacks->roomKeyChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->roomKeyChanged,
                      callbacks->param,
                      PI_ROOM_KEY_CHANGED_CALLBACK,
                      &params,
                      sizeof(piRoomKeyChangedParams),
                      -1);
    }
}
...
static void piGetGlobalKeysCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerGetGlobalKeysCallback)data->callback)(peer,
                                                data->success,
                                                params->nick,
                                                params->num,
                                                (const char**)params->keys,
                                                (const char**)params->values,
                                                data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ...
        ((peerGetGlobalKeysCallback)data->callback)(peer,
                                                    ...
                                                    nick_W,
                                                    params->num,
                                                    (const unsigned short**)keys_W,
                                                    (const unsigned short**)values_W,
                                                    data->callbackParam);
        gsifree(nick_W);
        for (i = 0; i < params->num; i++) {
            gsifree(keys_W[i]);
...
void piAddGetGlobalKeysCallback(PEER peer,
                                PEERBool success,
                                const char* nick,
                                int num,
                                const char** keys,
...
static void piGetRoomKeysCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerGetRoomKeysCallback)data->callback)(peer,
                                              data->success,
                                              params->roomType,
                                              params->nick,
                                              params->num,
...
#else
    {
        ...
        unsigned short** values_W = UTF8ToUCS2StringArrayAlloc((const UTF8String*)params->values, params->num);
        int i;
        ((peerGetRoomKeysCallback)data->callback)(
            peer, data->success, params->roomType, nick_W, params->num, keys_W, values_W, data->callbackParam);
        gsifree(nick_W);
        for (i = 0; i < params->num; i++) {
            gsifree(keys_W[i]);
            if (values_W != NULL) // may be a NULL when getting keys for "*"
...
void piAddGetRoomKeysCallback(PEER peer,
                              PEERBool success,
                              RoomType roomType,
                              const char* nick,
                              int num,
...
static void piPlayerFlagsChangedCall(PEER peer, piCallbackData* data)
{
    ...
    params = data->params;
#ifndef GSI_UNICODE
    ((peerPlayerFlagsChangedCallback)data->callback)(
        peer, params->roomType, params->nick, params->oldFlags, params->newFlags, data->callbackParam);
#else
    {
        unsigned short* nick_W = UTF8ToUCS2StringAlloc(params->nick);
        ((peerPlayerFlagsChangedCallback)data->callback)(
            peer, params->roomType, nick_W, params->oldFlags, params->newFlags, data->callbackParam);
        gsifree(nick_W);
    }
#endif
}
void piAddPlayerFlagsChangedCallback(PEER peer, RoomType roomType, const char* nick, int oldFlags, int newFlags)
{
    ...
    if (callbacks->playerFlagsChanged) {
        ...
        piAddCallback(peer,
                      PEERTrue,
                      (PEERCBType)callbacks->playerFlagsChanged,
                      callbacks->param,
                      PI_PLAYER_FLAGS_CHANGED_CALLBACK,
                      &params,
                      sizeof(piPlayerFlagsChangedParams),
                      -1);
    }
}
...
void piAddAuthenticateCDKeyCallback(PEER peer,
                                    int result,
                                    const char* message,
                                    ...
                                    int opID)
{
    ...
    piAddCallback(peer,
                  ...
                  &params,
                  sizeof(piAuthenticateCDKeyParams),
                  opID);
}
...
void piAddAutoMatchStatusCallback(PEER peer)
{
    ...
    piAddCallback(peer,
                  PEERTrue,
                  operation->callback,
                  operation->callbackParam,
                  PI_AUTO_MATCH_STATUS_CALLBACK,
                  &params,
                  sizeof(piAutoMatchStatusParams),
                  operation->ID);
}
...
int piCallAutoMatchRateCallback(PEER peer, SBServer server)
{
    ...
    return ((peerAutoMatchRateCallback)connection->autoMatchOperation->callback2)(
        peer, server, operation->callbackParam);
}
...
static const piCallbackFuncs callbackFuncs[] = {
    {PI_CONNECT_CALLBACK, piConnectCopy, piConnectFree, piConnectCall},
    {PI_JOIN_ROOM_CALLBACK, piJoinRoomCopy, piJoinRoomFree, piJoinRoomCall},
    {PI_LIST_GROUP_ROOMS_CALLBACK, piListGroupRoomsCopy, piListGroupRoomsFree, piListGroupRoomsCall},
    {PI_LISTING_GAMES_CALLBACK, piListingGamesCopy, piListingGamesFree, piListingGamesCall},
    {PI_NICK_ERROR_CALLBACK, piNickErrorCopy, piNickErrorFree, piNickErrorCall},
    {PI_ENUM_PLAYERS_CALLBACK, piEnumPlayersCopy, piEnumPlayersFree, piEnumPlayersCall},
    {PI_GET_PLAYER_INFO_CALLBACK, piGetPlayerInfoCopy, piGetPlayerInfoFree, piGetPlayerInfoCall},
    {PI_GET_PLAYER_PROFILE_ID_CALLBACK, piGetPlayerProfileIDCopy, piGetPlayerProfileIDFree, piGetPlayerProfileIDCall},
    {PI_GET_PLAYER_IP_CALLBACK, piGetPlayerIPCopy, piGetPlayerIPFree, piGetPlayerIPCall},
    {PI_ROOM_MESSAGE_CALLBACK, piRoomMessageCopy, piRoomMessageFree, piRoomMessageCall},
    {PI_ROOM_UTM_CALLBACK, piRoomUTMCopy, piRoomUTMFree, piRoomUTMCall},
    {PI_ROOM_NAME_CHANGED_CALLBACK, piRoomNameChangedCopy, piRoomNameChangedFree, piRoomNameChangedCall},
    {PI_ROOM_MODE_CHANGED_CALLBACK, piRoomModeChangedCopy, piRoomModeChangedFree, piRoomModeChangedCall},
    {PI_PLAYER_MESSAGE_CALLBACK, piPlayerMessageCopy, piPlayerMessageFree, piPlayerMessageCall},
    {PI_PLAYER_UTM_CALLBACK, piPlayerUTMCopy, piPlayerUTMFree, piPlayerUTMCall},
    {PI_READY_CHANGED_CALLBACK, piReadyChangedCopy, piReadyChangedFree, piReadyChangedCall},
    {PI_GAME_STARTED_CALLBACK, piGameStartedCopy, piGameStartedFree, piGameStartedCall},
    {PI_PLAYER_JOINED_CALLBACK, piPlayerJoinedCopy, piPlayerJoinedFree, piPlayerJoinedCall},
    {PI_PLAYER_LEFT_CALLBACK, piPlayerLeftCopy, piPlayerLeftFree, piPlayerLeftCall},
    {PI_KICKED_CALLBACK, piKickedCopy, piKickedFree, piKickedCall},
    {PI_NEW_PLAYER_LIST_CALLBACK, piNewPlayerListCopy, piNewPlayerListFree, piNewPlayerListCall},
    {PI_PLAYER_CHANGED_NICK_CALLBACK, piPlayerChangedNickCopy, piPlayerChangedNickFree, piPlayerChangedNickCall},
    {PI_PLAYER_INFO_CALLBACK, piPlayerInfoCopy, piPlayerInfoFree, piPlayerInfoCall},
    {PI_DISCONNECTED_CALLBACK, piDisconnectedCopy, piDisconnectedFree, piDisconnectedCall},
    {PI_PING_CALLBACK, piPingCopy, piPingFree, piPingCall},
    {PI_CROSS_PING_CALLBACK, piCrossPingCopy, piCrossPingFree, piCrossPingCall},
    {PI_CHANGE_NICK_CALLBACK, piChangeNickCopy, piChangeNickFree, piChangeNickCall},
    {PI_GLOBAL_KEY_CHANGED_CALLBACK, piGlobalKeyChangedCopy, piGlobalKeyChangedFree, piGlobalKeyChangedCall},
    {PI_ROOM_KEY_CHANGED_CALLBACK, piRoomKeyChangedCopy, piRoomKeyChangedFree, piRoomKeyChangedCall},
    {PI_GET_GLOBAL_KEYS_CALLBACK, piGetGlobalKeysCopy, piGetGlobalKeysFree, piGetGlobalKeysCall},
    {PI_GET_ROOM_KEYS_CALLBACK, piGetRoomKeysCopy, piGetRoomKeysFree, piGetRoomKeysCall},
    {PI_PLAYER_FLAGS_CHANGED_CALLBACK, piPlayerFlagsChangedCopy, piPlayerFlagsChangedFree, piPlayerFlagsChangedCall},
    {PI_AUTHENTICATE_CDKEY_CALLBACK, piAuthenticateCDKeyCopy, piAuthenticateCDKeyFree, piAuthenticateCDKeyCall},
    {PI_AUTO_MATCH_STATUS_CALLBACK, piAutoMatchStatusCopy, piAutoMatchStatusFree, piAutoMatchStatusCall},
    {PI_NUM_CALLBACK_TYPES, NULL, NULL, NULL}};
...
static int GS_STATIC_CALLBACK piIsCallbackFinishedCompareCallback(const void* elem1, const void* elem2)
{
