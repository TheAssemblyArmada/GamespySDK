...
static MenuScreenConfiguration msCheckingBackendAvailability = {"Checking Backend Availability",
                                                                {{mscCancel}},
...
static MenuScreenConfiguration msBackendUnavailable = {"Backend Unavailable",
                                                       {{mscExit}},
                                                       NULL,
...
static MenuScreenConfiguration msFailedToIntializePeerSDK = {"Failed to Initialize Peer SDK",
                                                             {{mscExit}},
                                                             NULL,
...
static MenuScreenConfiguration msHostOrList = {"Host or List",
                                               {{mscHostServer}, {mscListServers}, {mscExit}},
                                               NULL,
                                               HostOrListChose};
...
static MenuScreenConfiguration msChooseHostingName = {"Choose Hosting Name",
                                                      {{mscStartHosting}, {mscCancel}},
...
static MenuScreenConfiguration msHostingServer = {"Hosting Server",
                                                  {{mscStopHosting}},
                                                  HostingServerInit,
                                                  HostingServerChose,
                                                  HostingServerThink,
...
static MenuScreenConfiguration msErrorStartingHost = {"Error Starting Host",
                                                      {{mscMainMenu}},
...
static MenuScreenConfiguration msListingHosts = {"Listing Hosts",
                                                 {{mscViewHostInfo, CHOICE_OPTION_NEEDS_LIST_SELECTION}, {mscMainMenu}},
                                                 ListingHostsInit,
                                                 ListingHostsChose,
                                                 ListingHostsThink,
...
static MenuScreenConfiguration msErrorListingHosts = {"Error Listing Hosts",
                                                      {{mscMainMenu}},
...
static MenuScreenConfiguration msViewHostInfo =
    {"View Host Info", {{mscBack}}, ViewHostInfoInit, ViewHostInfoChose, NULL, SCREEN_OPTION_EXTRAS_CENTERED};
...
static void
DebugCallback(GSIDebugCategory category, GSIDebugType type, GSIDebugLevel level, const char* format, va_list params)
{
    // Output line prefix
    Printf("[%s][%s][%s] ",
...
static void ListingGamesCallback(PEER peer,
                                 PEERBool success,
                                 const gsi_char* name,
                                 SBServer server,
                                 PEERBool staging,
...
static void ViewHostInfoInit(void)
{
    ...
    snprintf(screen->extraText[line++],
             ...
             "  %s",
             SBServerGetStringValue(SelectedServer, "hostname", "N/A"));
    ...
    snprintf(screen->extraText[line++],
             MAX_EXTRA_TEXT_STRING_LEN,
             "  %s:%d",
             SBServerGetPublicAddress(SelectedServer),
             SBServerGetPublicQueryPort(SelectedServer));
    ...
    snprintf(screen->extraText[line++],
             MAX_EXTRA_TEXT_STRING_LEN,
             "  %s:%d",
             SBServerGetPrivateAddress(SelectedServer),
             SBServerGetPrivateQueryPort(SelectedServer));
    ...
    snprintf(screen->extraText[line++],
             MAX_EXTRA_TEXT_STRING_LEN,
             "  %s",
             SBServerGetStringValue(SelectedServer, "mapname", "N/A"));
    ...
    snprintf(screen->extraText[line++],
             MAX_EXTRA_TEXT_STRING_LEN,
             "  %s",
             SBServerGetStringValue(SelectedServer, "gametype", "N/A"));
}
static void ViewHostInfoChose(const char* choice)
{
    if (choice == mscBack)
