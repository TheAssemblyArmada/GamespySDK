...
template <typename T, unsigned Alignment> class spursAlignedAllocator
{
...
public:
	...
	*/
    ...
    template <typename Other> spursAlignedAllocator(const spursAlignedAllocator<Other, Alignment>&)
    {
    }
    ...
    template <typename O> self_type& operator=(const spursAlignedAllocator<O, Alignment>&)
    {
        return *this;
    }
