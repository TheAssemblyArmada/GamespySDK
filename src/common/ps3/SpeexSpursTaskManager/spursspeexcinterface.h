...
int issueSampleTaskEncode(short* inBuffer,
                          int inBufferSize,
                          int encodedFrameSize,
                          char* outBuffer,
                          int outBufferSize,
                          struct SpursSpeexTaskOutput* taskOuput,
                          char* userAllocatedSpeexBuffer,
                          int userAllocatedSpeexBufferSize);

///not finished, need to pass proper data
int issueSampleTaskEncodeInit(int quality,
                              int samplesPerFrame,
...
int issueSampleTaskDecodeAdd(char* decoderStateBuffer,
                             ...
                             int outBufferSize,
                             struct SpursSpeexTaskOutput* taskOutput);
int issueSampleTaskDecodeSet(char* decoderStateBuffer,
                             int decoderStateBufferSize,
                             char* inBuffer,
                             int inBufferSize,
                             int encodedFrameSize,
