...
void pinged(unsigned int IP, unsigned short port, int ping, const char* data, int len, void* param)
{
    IN_ADDR addr;
    addr.S_un.S_addr = IP;
...
void reply(unsigned int IP, unsigned short port, int ping, const char* data, int len, void* param)
{
    IN_ADDR addr;
    addr.S_un.S_addr = IP;
