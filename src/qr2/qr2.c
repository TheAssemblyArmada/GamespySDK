...
qr2_error_t qr2_initW(/*[out]*/ qr2_t* qrec,
                      const unsigned short* ip,
                      int baseport,
                      const unsigned short* gamename,
                      const unsigned short* secret_key,
                      int ispublic,
                      int natnegotiate,
                      ...
                      void* userdata);
qr2_error_t qr2_init_socketW(/*[out]*/ qr2_t* qrec,
                             SOCKET s,
                             int boundport,
                             const unsigned short* gamename,
                             const unsigned short* secret_key,
...
qr2_error_t qr2_init_socketA(/*[out]*/ qr2_t* qrec,
                             ...
                             qr2_adderrorcallback_t adderror_callback,
                             void* userdata);
qr2_error_t qr2_initA(/*[out]*/ qr2_t* qrec,
                      const char* ip,
                      int baseport,
                      const char* gamename,
                      const char* secret_key,
                             ...
                             void* userdata)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_init_socket()\r\n");
                             ...
                             void* userdata)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_init_socketW()\r\n");

    UCS2ToAsciiString(gamename, gamename_A);
    UCS2ToAsciiString(secret_key, secretkey_A);

    return qr2_init_socketA(qrec,
                            s,
                            boundport,
                            gamename_A,
                            secretkey_A,
...
qr2_error_t qr2_create_socket(/*[out]*/ SOCKET* sock, const char* ip, /*[in/out]*/ int* port)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_create_socket()\r\n");
    ...
    if (INVALID_SOCKET == hbsock) {
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_HotError, "Failed to create heartbeat socket\r\n");
    ...
    {
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_HotError, "Failed to bind() query socket\r\n");
                      ...
                      void* userdata)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_init()\r\n");
                      ...
                      void* userdata)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_initW()\r\n");
...
{
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_register_natneg_callback()\r\n");
...
{
    gsDebugFormat(
        GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_register_clientmessage_callback()\r\n");
...
{
    gsDebugFormat(
        GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_register_publicaddress_callback()\r\n");
...
{
    gsDebugFormat(
        GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_register_clientconnected_callback()\r\n");
...
{
    gsDebugFormat(
        GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_register_denyresponsetoip_callback()\r\n");
    ...
    while (CanReceiveOnSocket(qrec->hbsock)) {
        ...
        if (gsiSocketIsNotError(error)) {
            ...
            gsDebugFormat(GSIDebugCat_QR2,
                          ...
                          error);
            gsDebugBinary(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_RawDump, indata, error);
...
void qr2_check_send_heartbeat(qr2_t qrec)
{
    ...
    if (INVALID_SOCKET == qrec->hbsock) {
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_WarmError, "HBSock is invalid\r\n");
...
#ifndef GSI_UNICODE
            qrec->adderror_callback(
                e_qrnochallengeerror, "No challenge value was received from the master server.", qrec->udata);
#else
            qrec->adderror_callback(
                e_qrnochallengeerror, L"No challenge value was received from the master server.", qrec->udata);
#endif
            return;
        } else {
...
{
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_StackTrace, "qr2_send_statechanged()\r\n");
...
{
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_StackTrace, "qr2_shutdown()\r\n");
...
static void
NatNegCompletedCallback(NegotiateResult result, SOCKET gamesocket, struct sockaddr_in* remoteaddr, void* userdata)
{
...
static void qr_build_query_reply(qr2_t qrec,
                                 qr2_buffer_t buf,
                                 int serverkeycount,
                                 uchar* serverkeys,
                                 int playerkeycount,
...
static void qr_process_query(qr2_t qrec, qr2_buffer_t buf, uchar* qdata, int len, struct sockaddr* sender)
{
    ...
    if ((exflags & QR2_EXFLAG_SPLIT) == QR2_EXFLAG_SPLIT) {
        ...
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Comment, "Building query reply (single packet)\r\n");
...
{
    unsigned char natNegBytes[NATNEG_MAGIC_LEN] = {
        NN_MAGIC_0, NN_MAGIC_1, NN_MAGIC_2, NN_MAGIC_3, NN_MAGIC_4, NN_MAGIC_5};
    int i;
    int isnatneg = 1;

    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Misc, GSIDebugLevel_Notice, "Processing client message\r\n");
    ...
    if (isnatneg) {
        ...
        if (qrec->cc_callback) {
            ...
            // do the negotiation
            error = NNBeginNegotiationWithSocket(
                qrec->hbsock, cookie, 1, NatNegProgressCallback, NatNegCompletedCallback, qrec);
            if (error != ne_noerror) {
...
void qr2_parse_queryA(qr2_t qrec, char* query, int len, struct sockaddr* sender)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_StackTrace, "qr2_parse_queryA()\r\n");
    ...
    {
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Forwarding natneg query onto natneg sdk\r\n");
...
//#define SIMULATE_FIREWALL
    ...
    case PACKET_PREQUERY_IP_VERIFY:
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Received IP verify challenge request\r\n");
    ...
    case PACKET_QUERY:
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Processing query packet\r\n");
    ...
    case PACKET_CHALLENGE:
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Processing challenge packet\r\n");
        ...
        break;
    case PACKET_ECHO:
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Processing echo packet\r\n");
    ...
    case PACKET_ADDERROR:
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_WarmError, "Processing adderror packet\r\n");
    ...
    case PACKET_CLIENT_MESSAGE:
        gsDebugFormat(
            GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Notice, "Processing clientmessage packet\r\n");
    ...
    case PACKET_KEEPALIVE:
        gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Comment, "Processing keepalive packet\r\n");
    ...
    gsDebugFormat(GSIDebugCat_QR2,
                  ...
                  buf.len);
    gsDebugBinary(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_RawDump, buf.buffer, buf.len);
}
...
static void send_keepalive(qr2_t qrec)
{
    ...
    gsDebugFormat(GSIDebugCat_QR2, GSIDebugType_Network, GSIDebugLevel_Comment, "Sent keepalive to master\r\n", buf);
}
