...
static void
ChangedNickCallback(CHAT chat, CHATBool success, const gsi_char* oldNick, const gsi_char* newNick, void* param)
{
    if (success) {
...
static void
ChannelMessage(CHAT chat, const gsi_char* channel, const gsi_char* user, const gsi_char* message, int type, void* param)
{
...
static void UserParted(CHAT chat,
...
static void
UserChangedNick(CHAT chat, const gsi_char* channel, const gsi_char* oldNick, const gsi_char* newNick, void* param)
{
...
static void NickErrorCallback(CHAT chat,
                              int type,
                              const gsi_char* nick,
...
static void
EnterChannelCallback(CHAT chat, CHATBool success, CHATEnterResult result, const gsi_char* channel, void* param)
{
...
static void GetUserInfoCallback(CHAT chat,
                                CHATBool success,
                                const gsi_char* nick,
                                const gsi_char* user,
                                const gsi_char* name,
...
*/
static void EnumUsersCallback(CHAT chat,
                              CHATBool success,
                              const gsi_char* channel,
                              int numUsers,
...
int test_main(int argc, char** argv)
{
    ...
    // Connect.
    ///////////
    chat = chatConnectSecure(serverAddress[0] ? serverAddress : NULL,
                             port,
                             chatNick,
                             chatName,
                             gamename,
