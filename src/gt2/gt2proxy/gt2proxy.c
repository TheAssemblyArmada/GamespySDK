...
void ClientReceivedCallback(GT2Connection connection, GT2Byte* message, int len, GT2Bool reliable)
{
...
void ClientClosedCallback(GT2Connection connection, GT2CloseReason reason)
{
    GT2Connection serverConnection;
...
GT2ConnectionCallbacks ClientConnectionCallbacks = {NULL, ClientReceivedCallback, ClientClosedCallback};

/* SERVER CONNECTIONS */

void ServerSocketErrorCallback(GT2Socket socket)
{
...
void ServerConnectedCallback(GT2Connection connection, GT2Result result, GT2Byte* message, int len)
{
...
void ServerReceivedCallback(GT2Connection connection, GT2Byte* message, int len, GT2Bool reliable)
{
    GT2Connection clientConnection;
...
void ServerClosedCallback(GT2Connection connection, GT2CloseReason reason)
{
    GT2Connection clientConnection;
...
GT2ConnectionCallbacks ServerConnectionCallbacks = {ServerConnectedCallback,
...
void ConnectAttemptCallback(GT2Socket socket,
                            ...
                            int len)
{
    ...
    //////////////////////////////
    result = gt2Connect(
        serverSocket, &serverConnection, RemoteAddress, message, len, 0, &ServerConnectionCallbacks, GT2False);
    if (result != GT2Success) {
