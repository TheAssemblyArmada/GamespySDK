...
#define GT_DECODE_ELEM(TYPE, b, l, args)                                                                               \
    {                                                                                                                  \
        if (l < sizeof(TYPE))                                                                                          \
            return -1;                                                                                                 \
        gt2MemCopy((char*)va_arg(*args, TYPE*), b, sizeof(TYPE));                                                      \
        return sizeof(TYPE);                                                                                           \
    }
...
#define GT_ENCODE_ELEM_NC(TYPE, b, l, args)                                                                            \
    {                                                                                                                  \
        if (l < sizeof(TYPE))                                                                                          \
            return -1;                                                                                                 \
        memcpy(b, &va_arg(*args, TYPE), sizeof(TYPE));                                                                 \
        return sizeof(TYPE);                                                                                           \
    }
#define GT_DECODE_ELEM_NC(TYPE, b, l, args)                                                                            \
    {                                                                                                                  \
        if (l < sizeof(TYPE))                                                                                          \
            return -1;                                                                                                 \
        memcpy(va_arg(*args, TYPE*), b, sizeof(TYPE));                                                                 \
        return sizeof(TYPE);                                                                                           \
    }
...
static int gtInternalEncodeV(int usetype,
