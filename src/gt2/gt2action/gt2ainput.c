...
static void SpecialKeyboardPress(int key, int dummyx, int dummyy)
{
    switch (key) {
    case GLUT_KEY_UP:
        upPressed = GT2True;
...
static void SpecialKeyboardRelease(int key, int dummyx, int dummyy)
{
    switch (key) {
    case GLUT_KEY_UP:
        upPressed = GT2False;
...
static void ChatAddChar(char c)
{
...
static void ChatBackspace(void)
{
    if (nChatChars)
        chatBuffer[--nChatChars] = '\0';
}
...
static void ChatKeyboardPress(unsigned char key, int x, int y)
{
    switch (key) {
    case 0x1B: // esc
...
static void ChatKeyboardRelease(unsigned char key, int x, int y)
{
    switch (key) {
    }
}
...
static void MainMenuCallback(int item)
{
    switch (item) {
...
static void GraphMenuCallback(int item)
{
    switch (item) {
...
static void DrawMenuCallback(int item)
{
    switch (item) {
    case DrawToggleFPS:
...
static void RadarMenuCallback(int item)
{
    switch (item) {
    case RadarDrawRadar:
