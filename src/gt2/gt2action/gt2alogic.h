...
typedef void (*Think)(struct SObject* self);

typedef void (*TouchObject)(struct SObject* self, struct SObject* object);

typedef void (*Die)(struct SObject* self);

typedef void (*TouchClient)(struct SObject* self, struct Client* client);
