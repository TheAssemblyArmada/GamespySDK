...
GT2Bool gti2ConnectAttemptCallback(GT2Socket socket,
...
GT2Bool gti2ConnectedCallback(GT2Connection connection, GT2Result result, GT2Byte* message, int len)
{
    assert(connection);
    if (!connection)
        return GT2True;
...
GT2Bool gti2ReceivedCallback(GT2Connection connection, GT2Byte* message, int len, GT2Bool reliable)
{
    assert(connection);
    if (!connection)
        return GT2True;
...
GT2Bool gti2ClosedCallback(GT2Connection connection, GT2CloseReason reason)
{
    assert(connection);
    if (!connection)
        return GT2True;
...
GT2Bool gti2PingCallback(GT2Connection connection, int latency)
{
    assert(connection);
    if (!connection)
        return GT2True;
...
GT2Bool
gti2SendFilterCallback(GT2Connection connection, int filterID, const GT2Byte* message, int len, GT2Bool reliable)
{
...
GT2Bool gti2ReceiveFilterCallback(GT2Connection connection, int filterID, GT2Byte* message, int len, GT2Bool reliable)
{
...
GT2Bool gti2DumpCallback(GT2Socket socket,
                         GT2Connection connection,
                         unsigned int ip,
                         unsigned short port,
                         GT2Bool reset,
...
GT2Bool gti2UnrecognizedMessageCallback(GT2Socket socket,
                                        unsigned int ip,
                                        unsigned short port,
                                        GT2Byte* message,
                                        int len,
