///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
#include "sake/sakemain.h"
#include "sake/sakerequest.h"
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeCreateRecord(SAKE sake,
                                       SAKECreateRecordInput* input,
                                       SAKERequestCallback callback,
                                       void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_CREATE_RECORD, sakeiStartCreateRecordRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeUpdateRecord(SAKE sake,
                                       SAKEUpdateRecordInput* input,
                                       SAKERequestCallback callback,
                                       void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_UPDATE_RECORD, sakeiStartUpdateRecordRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeDeleteRecord(SAKE sake,
                                       SAKEDeleteRecordInput* input,
                                       SAKERequestCallback callback,
                                       void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_DELETE_RECORD, sakeiStartDeleteRecordRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeSearchForRecords(SAKE sake,
                                           SAKESearchForRecordsInput* input,
                                           SAKERequestCallback callback,
                                           void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_SEARCH_FOR_RECORDS, sakeiStartSearchForRecordsRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetMyRecords(SAKE sake,
                                       SAKEGetMyRecordsInput* input,
                                       SAKERequestCallback callback,
                                       void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_GET_MY_RECORDS, sakeiStartGetMyRecordsRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetSpecificRecords(SAKE sake,
                                             SAKEGetSpecificRecordsInput* input,
                                             SAKERequestCallback callback,
                                             void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_GET_SPECIFIC_RECORDS, sakeiStartGetSpecificRecordsRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRandomRecord(SAKE sake,
                                          SAKEGetRandomRecordInput* input,
                                          SAKERequestCallback callback,
                                          void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_GET_RANDOM_RECORD, sakeiStartGetRandomRecordRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeRateRecord(SAKE sake,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordLimit(SAKE sake,
                                         SAKEGetRecordLimitInput* input,
                                         SAKERequestCallback callback,
                                         void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_GET_RECORD_LIMIT, sakeiStartGetRecordLimitRequest);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL sakeGetRecordCount(SAKE sake,
                                         SAKEGetRecordCountInput* input,
                                         SAKERequestCallback callback,
                                         void* userData)
{
    return sakeiRunRequest(
        sake, input, callback, userData, SAKEIRequestType_GET_RECORD_COUNT, sakeiStartGetRecordCountRequest);
}
...
gsi_bool SAKE_CALL sakeGetFileDownloadURL(SAKE sake, int fileId, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    if (gSakeDownloadUrlOverride[0] != '\0') {
        rcode = _tsnprintf(url,
                           SAKE_MAX_URL_LENGTH,
                           _T("%s?gameid=%d&pid=%d"),
                           gSakeDownloadUrlOverride,
                           sake->mGameId,
                           sake->mProfileId);
    } else {
#ifdef GSI_UNICODE
        {
            ...
            rcode = _tsnprintf(url,
                               SAKE_MAX_URL_LENGTH,
                               _T("http://%S.sake.%S/SakeFileServer/download.aspx?fileid=%d&gameid=%d&pid=%d"),
                               sake->mGameName,
                               GSI_DOMAIN_NAME,
                               fileId,
                               sake->mGameId,
...
gsi_bool SAKE_CALL sakeGetFileUploadURL(SAKE sake, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    if (gSakeUploadUrlOverride[0] != '\0') {
...
#ifdef GSI_UNICODE
        {
            ...
            rcode = _tsnprintf(url,
                               SAKE_MAX_URL_LENGTH,
                               _T("http://%S.sake.%S/SakeFileServer/upload.aspx?gameid=%d&pid=%d"),
                               sake->mGameName,
                               GSI_DOMAIN_NAME,
                               sake->mGameId,
                               sake->mProfileId);
