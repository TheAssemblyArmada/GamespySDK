...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
const char* GSI_SAKE_SERVICE_NAMESPACES[GSI_SAKE_SERVICE_NAMESPACE_COUNT] = {"ns1=\"http://gamespy.net/sake\""};
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void SAKE_CALL sakeiSoapCallback(GHTTPResult httpResult,
                                        ...
                                        void* userData)
{
    ...
    if (result == SAKERequestResult_SUCCESS) {
        if (gsi_is_false(gsXmlMoveToStart(responseData))
            ...
            || gsi_is_false(gsXmlReadChildAsStringNT(
                responseData, request->mInfo->mResultTag, resultString, sizeof(resultString)))) {
...
static SAKEStartRequestResult SAKE_CALL sakeiSetupRequest(SAKERequest request)
{
    ...
    gsXmlWriteStringElement(
        request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "loginTicket", request->mSake->mLoginTicket);
