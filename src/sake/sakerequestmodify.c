///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
#include "sake/sakerequestinternal.h"
    ...
    for (i = 0; i < numFields; i++) {
        ...
        if (fields[i].mType == SAKEFieldType_BYTE) {
            ...
            gsXmlWriteIntElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value", (gsi_u32)fields[i].mValue.mInt);
            ...
            gsXmlWriteStringElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value", fields[i].mValue.mAsciiString);
            ...
            gsXmlWriteUnicodeStringElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value", fields[i].mValue.mUnicodeString);
            ...
            gsXmlWriteIntElement(request->mSoapRequest,
                                 GSI_SAKE_SERVICE_NAMESPACE,
                                 "value",
                                 (gsi_u32)(gsi_is_false(fields[i].mValue.mBoolean) ? 0 : 1));
            ...
            gsXmlWriteDateTimeElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value", fields[i].mValue.mDateAndTime);
            ...
            gsXmlWriteBase64BinaryElement(request->mSoapRequest,
                                          GSI_SAKE_SERVICE_NAMESPACE,
                                          "value",
                                          fields[i].mValue.mBinaryData.mValue,
                                          fields[i].mValue.mBinaryData.mLength);
...
{
    static SAKEIRequestInfo info = {sizeof(SAKECreateRecordOutput),
...
{
    static SAKEIRequestInfo info = {0,
