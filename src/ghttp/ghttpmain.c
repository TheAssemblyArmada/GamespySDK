...
GHTTPRequest ghttpGetExA(const char* URL,
                         const char* headers,
                         char* buffer,
                         int bufferSize,
                         GHTTPPost post,
                         ...
                         void* param);
GHTTPRequest ghttpSaveExA(const char* URL,
                          const char* filename,
                          const char* headers,
                          GHTTPPost post,
                          GHTTPBool throttle,
                          ...
                          ghttpCompletedCallback completedCallback,
                          void* param);
GHTTPRequest ghttpStreamExA(const char* URL,
                            const char* headers,
                            GHTTPPost post,
                            GHTTPBool throttle,
                            GHTTPBool blocking,
                            ...
                            ghttpCompletedCallback completedCallback,
                            void* param);
GHTTPRequest ghttpHeadExA(const char* URL,
                          const char* headers,
                          GHTTPBool throttle,
                          GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
                          ghttpCompletedCallback completedCallback,
                          void* param);
GHTTPRequest ghttpPostExA(const char* URL,
                          const char* headers,
                          GHTTPPost post,
                          GHTTPBool throttle,
                          GHTTPBool blocking,
...
/////////////////////////////////////////////
static void ghiHandleStatus(GHIConnection* connection)
{
...
////////////////////////////////////////////////////
static GHTTPBool ghiProcessConnection(GHIConnection* connection)
{
    GHTTPBool completed;
    ...
    if (connection->result == GHTTPRequestCancelled && !connection->completed
...
#ifdef GSI_UNICODE
GHTTPRequest
ghttpGetW(const unsigned short* URL, GHTTPBool blocking, ghttpCompletedCallback completedCallback, void* param)
{
    char URL_A[1024];
                         ...
                         void* param)
{
    ...
    if (connection->userBufferSupplied)
        ...
        bResult = ghiInitBuffer(
            connection, &connection->getFileBuffer, GET_FILE_BUFFER_INITIAL_SIZE, GET_FILE_BUFFER_INCREMENT_SIZE);
    if (!bResult) {
        ghiFreeConnection(connection);
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpGetExW(const unsigned short* URL,
...
GHTTPRequest ghttpSaveA(const char* URL,
                        const char* filename,
                        GHTTPBool blocking,
                        ghttpCompletedCallback completedCallback,
                        void* param)
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpSaveW(const unsigned short* URL,
...
static GHTTPRequest _ghttpSaveEx(const char* URL,
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpSaveExW(const unsigned short* URL,
                          const unsigned short* filename,
                          const unsigned short* headers,
                          GHTTPPost post,
                          GHTTPBool throttle,
                          ...
                          void* param)
{
    ...
    return _ghttpSaveEx(
        URL_A, filename, headers_A, post, throttle, blocking, progressCallback, completedCallback, param);
}
#endif

GHTTPRequest ghttpStreamA(const char* URL,
                          GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
                          ghttpCompletedCallback completedCallback,
                          void* param)
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpStreamW(const unsigned short* URL,
                          GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
                          ghttpCompletedCallback completedCallback,
                          void* param)
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpStreamExW(const unsigned short* URL,
                            const unsigned short* headers,
                            GHTTPPost post,
                            GHTTPBool throttle,
                            GHTTPBool blocking,
...
#ifdef GSI_UNICODE
GHTTPRequest
ghttpHeadW(const unsigned short* URL, GHTTPBool blocking, ghttpCompletedCallback completedCallback, void* param)
{
    char URL_A[1024] = {'\0'};
    UCS2ToAsciiString(URL, URL_A);
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpHeadExW(const unsigned short* URL,
                          const unsigned short* headers,
                          GHTTPBool throttle,
                          GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
...
GHTTPRequest
ghttpPostA(const char* URL, GHTTPPost post, GHTTPBool blocking, ghttpCompletedCallback completedCallback, void* param)
{
    return ghttpPostExA(URL, NULL, post, GHTTPFalse, blocking, NULL, completedCallback, param);
}
#ifdef GSI_UNICODE
GHTTPRequest ghttpPostW(const unsigned short* URL,
                        GHTTPPost post,
                        GHTTPBool blocking,
                        ghttpCompletedCallback completedCallback,
                        void* param)
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpPostExW(const unsigned short* URL,
                          const unsigned short* headers,
                          GHTTPPost post,
                          GHTTPBool throttle,
                          GHTTPBool blocking,
...
#ifdef GSI_UNICODE
GHTTPBool ghttpPostAddStringW(GHTTPPost post, const unsigned short* name, const unsigned short* string)
{
    char name_A[1024] = {'\0'};
...
GHTTPBool ghttpPostAddFileFromDiskA(GHTTPPost post,
                                    const char* name,
                                    const char* filename,
...
#ifdef GSI_UNICODE
GHTTPBool ghttpPostAddFileFromDiskW(GHTTPPost post,
...
GHTTPBool ghttpPostAddFileFromMemoryA(GHTTPPost post,
                                      const char* name,
                                      const char* buffer,
                                      int bufferLen,
                                      const char* reportFilename,
...
#ifdef GSI_UNICODE
GHTTPBool ghttpPostAddFileFromMemoryW(GHTTPPost post,
                                      const unsigned short* name,
                                      const char* buffer,
                                      int bufferLen,
                                      const unsigned short* reportFilename,
...
GHTTPBool ghttpPostAddXml(GHTTPPost post, GSXmlStreamWriter soap)
{
    GS_ASSERT(post != NULL);
    GS_ASSERT(soap != NULL);
