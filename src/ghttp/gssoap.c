...
#include "gssoap.h"
#include "../common/gsplatformthread.h"
...
GSSoapTask* gsiExecuteSoap(const char* theURL,
                           const char* theService,
                           GSXmlStreamWriter theRequestSoap,
...
GSSoapTask* gsiExecuteSoapCustom(const char* theURL,
                                 const char* theService,
                                 GSXmlStreamWriter theRequestSoap,
                                 GSSoapCallbackFunc theCallbackFunc,
                                 GSSoapCustomFunc theCustomFunc,
                                 void* theUserData)
{
    GSSoapTask* aSoapTask = NULL;
    GSTask* aCoreTask = NULL;
...
static void gsiSoapTaskExecute(void* theTask)
{
    ...
    aSoapTask->mRequestId = ghttpGetExA(aSoapTask->mURL,
                                        aSoapTask->mService,
                                        NULL,
                                        0,
                                        aSoapTask->mPostData,
...
static void gsiSoapTaskCallback(void* theTask, GSTaskResult theResult)
{
    ...
    (aSoapTask->mCallbackFunc)(
        aSoapTask->mRequestResult, aSoapTask->mRequestSoap, aSoapTask->mResponseSoap, aSoapTask->mUserData);
