...
///////////////////////////////////////////////////////////////
typedef void (*ptPatchCallback)(PTBool available,            // If PTTrue, a patch is available.
...
///////////////////////////////////////////////////////////////
PTBool ptCheckForPatch(int productID,                   // The ID of this product.
...
///////////////////////////////////////////////////////////////////////
PTBool ptTrackUsage(int userID,                      // The GP userID of the user who is using the product.  Can be 0.
...
///////////////////////////////////////////////////////
PTBool ptCheckForPatchAndTrackUsage(int userID,    // The GP userID of the user who is using the product.  Can be 0.
                                    int productID, // The ID of this product.
                                    const gsi_char* versionUniqueID, // A string uniquely identifying this version.
                                    int distributionID,              // The distribution ID for this version.  Can be 0.
                                    ptPatchCallback callback,        // The callback to call with the patch info.
...
// or a failure of -1
//////////////////////////////////////////////////////
PTBool ptCreateCheckPatchTrackUsageReq(int userID,    // The GP userID of the user who is using the product.  Can be 0.
                                       int productID, // The ID of this product.
                                       const gsi_char* versionUniqueID, // A string uniquely identifying this version.
                                       int distributionID,       // The distribution ID for this version.  Can be 0.
                                       ptPatchCallback callback, // The callback to call with the patch info.
...
////////////////////////////////////////////////////////
typedef void (*ptFilePlanetInfoCallback)(int fileID,   // The ID of the file for which info was looked up.
...
// be called.
////////////////////////////////////////////////////////////////
PTBool ptLookupFilePlanetInfo(int fileID,                        // The ID of the file to find info on.
