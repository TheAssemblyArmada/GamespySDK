...
** FUNCTIONS **
**************/
static const char* ptaGetKeyValue(const char* buffer, const char* key)
{
...
static int ptaFillLine(const char* buffer)
{
    char* str = Line;
    int i;
...
static void ptaCallPatchCallback(ptaPatchData* data,
                                 PTBool available,
                                 PTBool mandatory,
...
static GHTTPBool ptaPatchFailed(ptaPatchData* data)
{
...
static void ptaCallFilePlanetInfoCallback(ptaFilePlanetInfoData* data,
                                          PTBool found,
    ...
    if (data->callback) {
        if (!found)
            ...
            data->callback(data->fileID,
                           ...
                           size_W,
                           numMirrors,
                           (const unsigned short**)mirrorNames_W,
                           (const unsigned short**)mirrorURLs_W,
                           data->param);
...
// already returns ghttptrue
static GHTTPBool ptaFilePlanetInfoFailed(ptaFilePlanetInfoData* data)
{
...
static GHTTPBool
ptaPatchCompletedCallback(GHTTPRequest request, GHTTPResult result, char* buffer, GHTTPByteCount bufferLen, void* param)
{
...
PTBool ptCheckForPatchA(int productID,
...
#ifdef GSI_UNICODE
PTBool ptCheckForPatchW(int productID,
...
PTBool ptTrackUsageA(int userID, int productID, const char* versionUniqueID, int distributionID, PTBool blocking)
{
    int charsWritten;
    char aURL[PTA_MAX_STRING_SIZE];
...
#ifdef GSI_UNICODE
PTBool
ptTrackUsageW(int userID, int productID, const unsigned short* versionUniqueID, int distributionID, PTBool blocking)
{
    char versionUniqueID_A[255];
    UCS2ToUTF8String(versionUniqueID, versionUniqueID_A);
...
PTBool ptCreateCheckPatchTrackUsageReqA(int userID,
                                        int productID,
                                        const char* versionUniqueID,
                                        int distributionID,
                                        ptPatchCallback callback,
...
#ifdef GSI_UNICODE
PTBool ptCreateCheckPatchTrackUsageReqW(int userID,
                                        int productID,
                                        const unsigned short* versionUniqueID,
                                        int distributionID,
                                        ptPatchCallback callback,
                                        ...
                                        void* param)
{
    char versionUniqueID_A[255];
    UCS2ToUTF8String(versionUniqueID, versionUniqueID_A);
    return ptCreateCheckPatchTrackUsageReqA(
        userID, productID, versionUniqueID_A, distributionID, callback, blocking, request, param);
}
#endif

PTBool ptCheckForPatchAndTrackUsageA(int userID,
                                     int productID,
                                     const char* versionUniqueID,
                                     int distributionID,
                                     ptPatchCallback callback,
                                     ...
                                     void* param)
{
    ...
    ///////////////////////////////////
    return ptCreateCheckPatchTrackUsageReqA(
        userID, productID, versionUniqueID, distributionID, callback, blocking, &aRequest, param);
}

#ifdef GSI_UNICODE
PTBool ptCheckForPatchAndTrackUsageW(int userID,
                                     int productID,
                                     const unsigned short* versionUniqueID,
                                     int distributionID,
                                     ptPatchCallback callback,
                                     ...
                                     void* param)
{
    char versionUniqueID_A[255];
    UCS2ToUTF8String(versionUniqueID, versionUniqueID_A);
    return ptCheckForPatchAndTrackUsageA(
        userID, productID, versionUniqueID_A, distributionID, callback, blocking, param);
}
#endif

static GHTTPBool ptaFilePlanetCompletedCallback(GHTTPRequest request,
                                                GHTTPResult result,
                                                char* buffer,
...
//
PTBool ptLookupFilePlanetInfo(int fileID, ptFilePlanetInfoCallback callback, PTBool blocking, void* param)
{
    char aURL[PTA_MAX_STRING_SIZE];
    ...
    ///////////////////////////////////////////////
    snprintf(aURL, PTA_MAX_STRING_SIZE, "%s?file=%d&gamename=%s", gPTAFilePlanetURL, fileID, __GSIACGamename);
