                                 ...
                                 SCIReport** theReportOut)
{
    ...
    const gsi_u32 theRosterSize = SC_GUID_BINARY_SIZE * thePlayerCount + SC_REPORT_TEAMINDEX_LENGTH * thePlayerCount;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportSetPlayerConnectionId(SCIReport* theReport,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportSetPlayerAuthInfo(SCIReport* theReport,
                                            gsi_u32 thePlayerIndex,
...
SCResult SC_CALL sciReportBeginNewTeam(SCIReport* theReport)
{
    ...
    sciSerializeInt16((gsi_u8*)&theReport->mBuffer.mData[theReport->mCurEntityStartPos],
                      (gsi_i16)theReport->mCurEntityKeyCount);
...
SCResult SC_CALL sciReportBeginGlobalData(SCIReport* theReport)
{
    ...
    theReport->mBuffer.mPos = sizeof(SCIReportHeader) + aHeader->mRosterSectionLength + aHeader->mAuthSectionLength
                              + aHeader->mResultsSectionLength;
...
SCResult SC_CALL sciReportBeginPlayerData(SCIReport* theReport)
{
    ...
    GS_ASSERT(theReport->mReportState == SCIReportState_ROSTER || theReport->mReportState == SCIReportState_GLOBALDATA);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddIntValue(SCIReport* theReport, gsi_u16 theKeyId, gsi_i32 theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    int writtenLen = 0;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddInt64Value(SCIReport* theReport, gsi_u16 theKeyId, gsi_i64 theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    int writtenLen = 0;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddShortValue(SCIReport* theReport, gsi_u16 theKeyId, gsi_i16 theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    int writtenLen = 0;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddByteValue(SCIReport* theReport, gsi_u16 theKeyId, gsi_i8 theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    int writtenLen = 0;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddFloatValue(SCIReport* theReport, gsi_u16 theKeyId, float theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    int writtenLen = 0;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportAddStringValue(SCIReport* theReport, gsi_u16 theKeyId, const gsi_char* theValue)
{
    SCIReportHeader* aHeader = (SCIReportHeader*)theReport->mBuffer.mData;
    ...
    GS_ASSERT(((theReport->mBuffer.mPos + (_tcslen(theValue)) + (sizeof(gsi_u16) * 2)) < theReport->mBuffer.mCapacity));
