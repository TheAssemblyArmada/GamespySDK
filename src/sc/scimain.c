...
///////////////////////////////////////////////////////////////////////////////
#include "sc/sci.h"
#include "sc/sciinterface.h"
#include "sc/scireport.h"
                                 ...
                                 void* theUserData)
{
    ...
    return sciWsCreateSession(&anInterface->mWebServices,
                              anInterface->mGameId,
                              theCertificate,
                              thePrivateData,
                              theCallback,
                                          ...
                                          void* theUserData)
{
    ...
    return sciWsCreateMatchlessSession(&anInterface->mWebServices,
                                       anInterface->mGameId,
                                       theCertificate,
                                       thePrivateData,
                                       theCallback,
                                      ...
                                      void* theUserData)
{
    ...
    // Call web service
    return sciWsSetReportIntention(&anInterface->mWebServices,
                                   anInterface->mGameId,
                                   (char*)anInterface->mSessionId,
                                   (char*)anInterface->mConnectionId,
                                   isAuthoritative,
                                   theCertificate,
                                   thePrivateData,
                                   theCallback,
                                ...
                                void* theUserData)
{
    ...
    // Call web service
    return sciWsSubmitReport(&anInterface->mWebServices,
                             anInterface->mGameId,
                             (char*)anInterface->mSessionId,
                             (char*)anInterface->mConnectionId,
                             aReport,
                                ...
                                SCReportPtr* theReportDataOut)
{
    ...
    aResult = sciCreateReport(aInterface->mSessionId, theHeaderVersion, thePlayerCount, theTeamCount, &aReport);
    if (aResult == SCResult_NO_ERROR)
                                       ...
                                       const gsi_u8 theAuthHash[16])
{
    ...
    if (aResult == SCResult_NO_ERROR)
        aResult = sciReportSetPlayerConnectionId(aReport, thePlayerIndex, thePlayerConnectionId);
    if (aResult == SCResult_NO_ERROR)
        aResult = sciReportSetPlayerTeamIndex(aReport, thePlayerIndex, thePlayerTeamId);
    if (aResult == SCResult_NO_ERROR)
        aResult = sciReportSetPlayerGameResult(aReport, thePlayerIndex, theResult);
    if (aResult == SCResult_NO_ERROR)
        aResult = sciReportSetPlayerAuthInfo(aReport, thePlayerIndex, theCertificate, theAuthHash);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportSetTeamData(const SCReportPtr theReport, gsi_u32 theTeamId, SCGameResult theResult)
{
    SCIReport* aReport = NULL;
    gsi_u32 i;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddIntValue(const SCReportPtr theReport, gsi_u16 theKeyId, gsi_i32 theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
    aReport = (SCIReport*)theReport;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddInt64Value(SCReportPtr theReport, gsi_u16 theKeyId, gsi_i64 theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
    aReport = (SCIReport*)theReport;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddShortValue(const SCReportPtr theReport, gsi_u16 theKeyId, gsi_i16 theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
    aReport = (SCIReport*)theReport;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddByteValue(const SCReportPtr theReport, gsi_u16 theKeyId, gsi_i8 theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
    aReport = (SCIReport*)theReport;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddFloatValue(const SCReportPtr theReport, gsi_u16 theKeyId, float theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
    aReport = (SCIReport*)theReport;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL scReportAddStringValue(const SCReportPtr theReport, gsi_u16 theKeyId, const gsi_char* theValue)
{
    SCIReport* aReport = NULL;
    GS_ASSERT(theReport != NULL);
...
SCResult SC_CALL scPeerCipherInit(const GSLoginCertificate* theLocalCert, SCPeerCipher* theCipher)
{
    ...
    gsDebugBinary(
        GSIDebugCat_App, GSIDebugType_Misc, GSIDebugLevel_Notice, (char*)theCipher->mKey, (gsi_i32)theCipher->mKeyLen);
                                                  ...
                                                  SCPeerKeyExchangeMsg theMsgOut)
{
    ...
    if (0
        == gsCryptRSAEncryptBuffer(
            &theRemoteCert->mPeerPublicKey, theCipher->mKey, theCipher->mKeyLen, (unsigned char*)theMsgOut))
        return SCResult_NO_ERROR;
    else
                                                 ...
                                                 SCPeerCipher* theCipherOut)
{
    ...
    if (0
        == gsCryptRSADecryptBuffer(
            &theCertPrivateData->mPeerPrivateKey, (unsigned char*)theMsg, theCipherOut->mKey, &theCipherOut->mKeyLen)) {
        gsDebugFormat(GSIDebugCat_App, GSIDebugType_Misc, GSIDebugLevel_Notice, "Decrypted PeerCipher key block\r\n");
        gsDebugBinary(GSIDebugCat_App,
                      GSIDebugType_Misc,
                      GSIDebugLevel_Notice,
                      (char*)theCipherOut->mKey,
                      (gsi_i32)theCipherOut->mKeyLen);
