...
const char* SC_SERVICE_NAMESPACES[SC_SERVICE_NAMESPACE_COUNT] = {"gsc=\"http://gamespy.net/competition/\""};

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciWsInit(SCWebServices* theWebServices, SCInterfacePtr theInterface)
{
                            ...
                            void* theUserData)
{
    ...
    if (gsi_is_false(gsXmlWriteOpenTag(aRequest, "gsc", "CreateSession"))
        ...
        || gsi_is_false(gsXmlWriteHexBinaryElement(
            aRequest, "gsc", "proof", (const gsi_u8*)thePrivateData->mKeyHash, GS_CRYPT_MD5_HASHSIZE))
    ...
    // Execute soap call
    gsiExecuteSoap(scServiceURL, SC_CREATESESSION_SOAPACTION, aRequest, sciWsCreateSessionCallback, theWebServices);
                                     ...
                                     void* theUserData)
{
    ...
    // Execute soap call
    gsiExecuteSoap(
        scServiceURL, SC_CREATEMATCHLESSSESSION_SOAPACTION, aRequest, sciWsCreateSessionCallback, theWebServices);
    GSI_UNUSED(theTimeoutMs);
    return SCResult_NO_ERROR;
}
                                ...
                                void* theUserData)
{
    ...
    if (aWebServices->mCreateSessionCallback != NULL) {
        aWebServices->mCreateSessionCallback(
                                 ...
                                 void* theUserData)
{
    ...
    if (gsi_is_false(gsXmlWriteOpenTag(aRequest, "gsc", "SetReportIntention"))
        ...
        || gsi_is_false(gsXmlWriteIntElement(aRequest, "gsc", "gameid", (gsi_u32)theGameId))
        || gsi_is_false(
            gsXmlWriteIntElement(aRequest, "gsc", "authoritative", (gsi_u32)(gsi_is_true(isAuthoritative) ? 1 : 0)))
    ...
    // Execute soap call
    gsiExecuteSoap(scServiceURL, SC_SETINTENTION_SOAPACTION, aRequest, sciWsSetReportIntentionCallback, theWebServices);
                                     ...
                                     void* theUserData)
{
    ...
    if (aWebServices->mSetReportIntentionCallback != NULL) {
        aWebServices->mSetReportIntentionCallback(
...
extern GHTTPBool ghiPostAddFileFromMemory(GHTTPPost post,
                                          const char* name,
                                          const char* buffer,
                                          int bufferLen,
...
static void sciWsSubmitReportCustom(GHTTPPost thePost, void* theUserData)
{
    ...
    ghiPostAddFileFromMemory(thePost,
                             "report",
                             (char*)aWebServices->mSubmitReportData,
                             (gsi_i32)aWebServices->mSubmitReportLength,
                             "report",
                             "application/bin");
}
                           ...
                           void* theUserData)
{
    ...
    // Execute soap call
    gsiExecuteSoapCustom(scServiceURL,
                         SC_SUBMITREPORT_SOAPACTION,
                         aRequest,
                         sciWsSubmitReportCallback,
                         sciWsSubmitReportCustom,
                         theWebServices);
                               ...
                               void* theUserData)
{
    ...
    if (aWebServices->mSubmitReportDataCallback != NULL) {
        aWebServices->mSubmitReportDataCallback(
            aWebServices->mInterface, theHttpResult, aTranslatedResult, aWebServices->mSubmitReportUserData);
