...
ServerBrowser ServerBrowserNewA(const char* queryForGamename,
                                ...
                                void* instance)
{
    ...
    SBServerListInit(
        &sb->list, queryForGamename, queryFromGamename, queryFromKey, queryFromVersion, lanBrowse, ListCallback, sb);
                                ...
                                void* instance)
{
    ...
    return ServerBrowserNewA(forGameName_A,
                             fromGameName_A,
                             fromGameKey_A,
                             queryFromVersion,
                             maxConcUpdates,
...
SBError ServerBrowserBeginUpdate2(ServerBrowser sb,
                                  SBBool async,
...
SBError ServerBrowserUpdateA(ServerBrowser sb,
                             SBBool async,
                             SBBool disconnectOnComplete,
                             const unsigned char* basicFields,
                             int numBasicFields,
...
#ifdef GSI_UNICODE
SBError ServerBrowserUpdateW(ServerBrowser sb,
                             SBBool async,
                             SBBool disconnectOnComplete,
                             const unsigned char* basicFields,
                             int numBasicFields,
                             const unsigned short* serverFilter)
{
    ...
    return ServerBrowserUpdateA(
        sb, async, disconnectOnComplete, basicFields, numBasicFields, (serverFilter != NULL) ? serverFilter_A : NULL);
}
#endif

SBError ServerBrowserLimitUpdateA(ServerBrowser sb,
                                  SBBool async,
                                  SBBool disconnectOnComplete,
                                  const unsigned char* basicFields,
                                  int numBasicFields,
                                  ...
                                  int maxServers)
{
    return ServerBrowserBeginUpdate2(
        sb, async, disconnectOnComplete, basicFields, numBasicFields, serverFilter, LIMIT_RESULT_COUNT, maxServers);
}
#ifdef GSI_UNICODE
SBError ServerBrowserLimitUpdateW(ServerBrowser sb,
                                  SBBool async,
                                  SBBool disconnectOnComplete,
                                  const unsigned char* basicFields,
                                  int numBasicFields,
                                  ...
                                  int maxServers)
{
    ...
    if (serverFilter != NULL)
        UCS2ToUTF8String(serverFilter, serverFilter_A);
    return ServerBrowserLimitUpdateA(sb,
                                     async,
...
SBError
ServerBrowserLANUpdate(ServerBrowser sb, SBBool async, unsigned short startSearchPort, unsigned short endSearchPort)
{
...
SBError
ServerBrowserSendMessageToServerA(ServerBrowser sb, const char* ip, unsigned short port, const char* data, int len)
{
...
SBError ServerBrowserConnectToServer(ServerBrowser sb, SBServer server, SBConnectToServerCallback callback)
{
    ...
    sbError = ServerBrowserSendNatNegotiateCookieToServerA(
        sb, SBServerGetPublicAddress(server), SBServerGetPublicQueryPort(server), cookie);
...
SBError ServerBrowserAuxUpdateIPA(ServerBrowser sb,
                                  const char* ip,
                                  unsigned short port,
                                  SBBool viaMaster,
                                  SBBool async,
    ...
    if (!viaMaster) //do an engine query
    {
        ...
        if (i == -1) {
            server = SBQueryEngineUpdateServerByIP(
                &sb->engine, ip, port, 1, (fullUpdate) ? QTYPE_FULL : QTYPE_BASIC, usequerychallenge);
        ...
        if (server->state & (STATE_PENDINGBASICQUERY | STATE_PENDINGFULLQUERY | STATE_PENDINGICMPQUERY))
            ...
            SBQueryEngineUpdateServer(
                &sb->engine, server, 1, (fullUpdate) ? QTYPE_FULL : QTYPE_BASIC, usequerychallenge);
...
#ifdef GSI_UNICODE
SBError ServerBrowserAuxUpdateIPW(ServerBrowser sb,
                                  const unsigned short* ip,
                                  unsigned short port,
                                  SBBool viaMaster,
                                  SBBool async,
